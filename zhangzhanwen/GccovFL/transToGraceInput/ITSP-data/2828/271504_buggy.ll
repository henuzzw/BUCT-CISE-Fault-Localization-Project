; ModuleID = 'gcov/../WA_c/271504_buggy.c'
source_filename = "gcov/../WA_c/271504_buggy.c"
...
@.str.3 = private unnamed_addr constant [15 x i8] c"Capital Letter\00", align 1
...
; <label>:23:                                     ; preds = %17, %13
  ...
  %26 = icmp slt i32 65, %25, !dbg !37
  br i1 %26, label %27, label %33, !dbg !38

; <label>:27:                                     ; preds = %23
  %28 = load i8, i8* %2, align 1, !dbg !39
  %29 = sext i8 %28 to i32, !dbg !39
  %30 = icmp slt i32 %29, 90, !dbg !40
  br i1 %30, label %31, label %33, !dbg !41

; <label>:31:                                     ; preds = %27
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0)), !dbg !42
  br label %33, !dbg !44
...
!1 = !DIFile(filename: "gcov/../WA_c/271504_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2828")
!2 = !{}
...
!15 = !DILocation(line: 7, column: 12, scope: !16)
...
!20 = !DILocation(line: 7, column: 20, scope: !16)
...
!26 = distinct !DILexicalBlock(scope: !16, file: !1, line: 11, column: 13)
!27 = !DILocation(line: 11, column: 16, scope: !26)
!28 = !DILocation(line: 11, column: 20, scope: !26)
!29 = !DILocation(line: 11, column: 23, scope: !26)
!30 = !DILocation(line: 11, column: 25, scope: !26)
!31 = !DILocation(line: 11, column: 13, scope: !16)
...
!36 = distinct !DILexicalBlock(scope: !26, file: !1, line: 15, column: 13)
!37 = !DILocation(line: 15, column: 16, scope: !36)
!38 = !DILocation(line: 15, column: 20, scope: !36)
!39 = !DILocation(line: 15, column: 23, scope: !36)
!40 = !DILocation(line: 15, column: 25, scope: !36)
!41 = !DILocation(line: 15, column: 13, scope: !26)
