; ModuleID = 'gcov/../WA_c/271445_buggy.c'
source_filename = "gcov/../WA_c/271445_buggy.c"
...
; <label>:13:                                     ; preds = %11, %7, %0
  ...
  %16 = icmp sge i32 %15, 65, !dbg !27
  br i1 %16, label %17, label %23, !dbg !28

; <label>:17:                                     ; preds = %13
  %18 = load i8, i8* %2, align 1, !dbg !29
  %19 = sext i8 %18 to i32, !dbg !29
  %20 = icmp sle i32 %19, 90, !dbg !30
  br i1 %20, label %21, label %23, !dbg !31

; <label>:21:                                     ; preds = %17
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0)), !dbg !32
  br label %23, !dbg !34
...
; <label>:31:                                     ; preds = %27
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0)), !dbg !42
  br label %33, !dbg !44
...
!1 = !DIFile(filename: "gcov/../WA_c/271445_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2828")
!2 = !{}
...
!15 = !DILocation(line: 9, column: 8, scope: !16)
!16 = distinct !DILexicalBlock(scope: !7, file: !1, line: 9, column: 8)
!17 = !DILocation(line: 9, column: 10, scope: !16)
!18 = !DILocation(line: 9, column: 15, scope: !16)
!19 = !DILocation(line: 9, column: 17, scope: !16)
!20 = !DILocation(line: 9, column: 19, scope: !16)
!21 = !DILocation(line: 9, column: 8, scope: !7)
!22 = !DILocation(line: 11, column: 9, scope: !23)
!23 = distinct !DILexicalBlock(scope: !16, file: !1, line: 10, column: 5)
!24 = !DILocation(line: 12, column: 5, scope: !23)
!25 = !DILocation(line: 14, column: 8, scope: !26)
!26 = distinct !DILexicalBlock(scope: !7, file: !1, line: 14, column: 8)
!27 = !DILocation(line: 14, column: 10, scope: !26)
!28 = !DILocation(line: 14, column: 15, scope: !26)
!29 = !DILocation(line: 14, column: 17, scope: !26)
!30 = !DILocation(line: 14, column: 19, scope: !26)
!31 = !DILocation(line: 14, column: 8, scope: !7)
!32 = !DILocation(line: 16, column: 9, scope: !33)
!33 = distinct !DILexicalBlock(scope: !26, file: !1, line: 15, column: 5)
!34 = !DILocation(line: 17, column: 5, scope: !33)
!35 = !DILocation(line: 19, column: 8, scope: !36)
!36 = distinct !DILexicalBlock(scope: !7, file: !1, line: 19, column: 8)
!37 = !DILocation(line: 19, column: 10, scope: !36)
!38 = !DILocation(line: 19, column: 15, scope: !36)
!39 = !DILocation(line: 19, column: 17, scope: !36)
!40 = !DILocation(line: 19, column: 19, scope: !36)
!41 = !DILocation(line: 19, column: 8, scope: !7)
!42 = !DILocation(line: 21, column: 9, scope: !43)
!43 = distinct !DILexicalBlock(scope: !36, file: !1, line: 20, column: 5)
!44 = !DILocation(line: 22, column: 5, scope: !43)
!45 = !DILocation(line: 24, column: 5, scope: !7)
