; ModuleID = 'gcov/../WA_c/270100_buggy.c'
source_filename = "gcov/../WA_c/270100_buggy.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [5 x i8] c"%f%f\00", align 1
@.str.1 = private unnamed_addr constant [76 x i8] c"The area of (% .4f,%.4f), (% .4f,0) and (0,%.4f) is %                  .4f.\00", align 1
...
define i32 @main() #0 !dbg !366 {
  ...
  %12 = call double @llvm.fabs.f64(double %11), !dbg !380
  ...
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([76 x i8], [76 x i8]* @.str.1, i32 0, i32 0), double %15, double %17, double %19, double %21, double %23), !dbg !387
  ret i32 0, !dbg !388
}
...
!1 = !DIFile(filename: "gcov/../WA_c/270100_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!376 = !DILocation(line: 8, column: 19, scope: !366)
!377 = !DILocation(line: 8, column: 18, scope: !366)
!378 = !DILocation(line: 8, column: 21, scope: !366)
!379 = !DILocation(line: 8, column: 20, scope: !366)
!380 = !DILocation(line: 8, column: 10, scope: !366)
!381 = !DILocation(line: 8, column: 9, scope: !366)
!382 = !DILocation(line: 9, column: 90, scope: !366)
!383 = !DILocation(line: 9, column: 92, scope: !366)
!384 = !DILocation(line: 9, column: 94, scope: !366)
!385 = !DILocation(line: 9, column: 96, scope: !366)
!386 = !DILocation(line: 9, column: 98, scope: !366)
