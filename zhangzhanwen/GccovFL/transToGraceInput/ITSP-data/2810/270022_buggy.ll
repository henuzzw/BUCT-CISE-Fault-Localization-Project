; ModuleID = 'gcov/../WA_c/270022_buggy.c'
source_filename = "gcov/../WA_c/270022_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), float* %2), !dbg !375
  %6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)), !dbg !376
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), float* %3), !dbg !377
  %8 = load float, float* %2, align 4, !dbg !378
  %9 = load float, float* %3, align 4, !dbg !379
  %10 = fmul float %8, %9, !dbg !380
  %11 = fdiv float %10, 2.000000e+00, !dbg !381
  %12 = call float @_ZSt4fabsf(float %11), !dbg !382
  store float %12, float* %4, align 4, !dbg !383
  %13 = load float, float* %2, align 4, !dbg !384
  %14 = fpext float %13 to double, !dbg !384
  %15 = load float, float* %3, align 4, !dbg !385
  %16 = fpext float %15 to double, !dbg !385
  %17 = load float, float* %2, align 4, !dbg !386
  %18 = fpext float %17 to double, !dbg !386
  %19 = load float, float* %3, align 4, !dbg !387
  %20 = fpext float %19 to double, !dbg !387
  %21 = load float, float* %4, align 4, !dbg !388
  %22 = fpext float %21 to double, !dbg !388
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.2, i32 0, i32 0), double %14, double %16, double %18, double %20, double %22), !dbg !389
  ret i32 0, !dbg !390
}
...
define linkonce_odr float @_ZSt4fabsf(float) #3 comdat !dbg !391 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  call void @llvm.dbg.declare(metadata float* %2, metadata !392, metadata !DIExpression()), !dbg !393
  %3 = load float, float* %2, align 4, !dbg !394
  %4 = call float @llvm.fabs.f32(float %3), !dbg !395
  ret float %4, !dbg !396
}
...
!1 = !DIFile(filename: "gcov/../WA_c/270022_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!373 = !DILocalVariable(name: "area", scope: !366, file: !1, line: 6, type: !76)
!374 = !DILocation(line: 6, column: 11, scope: !366)
!375 = !DILocation(line: 7, column: 5, scope: !366)
!376 = !DILocation(line: 8, column: 5, scope: !366)
!377 = !DILocation(line: 9, column: 5, scope: !366)
!378 = !DILocation(line: 11, column: 15, scope: !366)
!379 = !DILocation(line: 11, column: 17, scope: !366)
!380 = !DILocation(line: 11, column: 16, scope: !366)
!381 = !DILocation(line: 11, column: 18, scope: !366)
!382 = !DILocation(line: 11, column: 10, scope: !366)
!383 = !DILocation(line: 11, column: 9, scope: !366)
!384 = !DILocation(line: 13, column: 69, scope: !366)
!385 = !DILocation(line: 13, column: 71, scope: !366)
!386 = !DILocation(line: 13, column: 73, scope: !366)
!387 = !DILocation(line: 13, column: 75, scope: !366)
!388 = !DILocation(line: 13, column: 77, scope: !366)
!389 = !DILocation(line: 13, column: 5, scope: !366)
!390 = !DILocation(line: 14, column: 5, scope: !366)
!391 = distinct !DISubprogram(name: "fabs", linkageName: "_ZSt4fabsf", scope: !5, file: !18, line: 241, type: !81, isLocal: false, isDefinition: true, scopeLine: 242, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!392 = !DILocalVariable(name: "__x", arg: 1, scope: !391, file: !18, line: 241, type: !76)
!393 = !DILocation(line: 241, column: 14, scope: !391)
!394 = !DILocation(line: 242, column: 28, scope: !391)
!395 = !DILocation(line: 242, column: 12, scope: !391)
!396 = !DILocation(line: 242, column: 5, scope: !391)
