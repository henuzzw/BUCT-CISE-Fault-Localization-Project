; ModuleID = 'gcov/../WA_c/270084_buggy.c'
source_filename = "gcov/../WA_c/270084_buggy.c"
...
define i32 @main() #0 !dbg !7 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), float* %2, float* %3), !dbg !16
  ...
  %13 = load float, float* %4, align 4, !dbg !24
  %14 = fcmp olt float %13, 0.000000e+00, !dbg !26
  br i1 %14, label %15, label %18, !dbg !27

; <label>:15:                                     ; preds = %0
  %16 = load float, float* %4, align 4, !dbg !28
  %17 = fsub float -0.000000e+00, %16, !dbg !30
  store float %17, float* %4, align 4, !dbg !31
  br label %18, !dbg !32

; <label>:18:                                     ; preds = %15, %0
  %19 = load float, float* %2, align 4, !dbg !33
  %20 = fpext float %19 to double, !dbg !33
  %21 = load float, float* %3, align 4, !dbg !34
  %22 = fpext float %21 to double, !dbg !34
  %23 = load float, float* %2, align 4, !dbg !35
  %24 = fpext float %23 to double, !dbg !35
  %25 = load float, float* %3, align 4, !dbg !36
  %26 = fpext float %25 to double, !dbg !36
  %27 = load float, float* %4, align 4, !dbg !37
  %28 = fpext float %27 to double, !dbg !37
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i32 0, i32 0), double %20, double %22, double %24, double %26, double %28), !dbg !38
  ret i32 0, !dbg !39
}
...
!1 = !DIFile(filename: "gcov/../WA_c/270084_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!25 = distinct !DILexicalBlock(scope: !7, file: !1, line: 8, column: 9)
...
!33 = !DILocation(line: 12, column: 69, scope: !7)
!34 = !DILocation(line: 12, column: 71, scope: !7)
!35 = !DILocation(line: 12, column: 73, scope: !7)
!36 = !DILocation(line: 12, column: 75, scope: !7)
!37 = !DILocation(line: 12, column: 77, scope: !7)
