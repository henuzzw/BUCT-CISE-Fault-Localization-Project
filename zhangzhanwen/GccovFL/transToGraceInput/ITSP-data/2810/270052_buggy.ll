; ModuleID = 'gcov/../WA_c/270052_buggy.c'
source_filename = "gcov/../WA_c/270052_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), float* %2, float* %3), !dbg !373
  call void @llvm.dbg.declare(metadata float* %4, metadata !374, metadata !DIExpression()), !dbg !375
  %6 = load float, float* %2, align 4, !dbg !376
  %7 = fpext float %6 to double, !dbg !376
  %8 = fmul double 5.000000e-01, %7, !dbg !377
  %9 = load float, float* %3, align 4, !dbg !378
  %10 = fpext float %9 to double, !dbg !378
  %11 = fmul double %8, %10, !dbg !379
  %12 = fptrunc double %11 to float, !dbg !380
  store float %12, float* %4, align 4, !dbg !375
  %13 = load float, float* %4, align 4, !dbg !381
  %14 = fcmp ogt float %13, 0.000000e+00, !dbg !383
  br i1 %14, label %15, label %27, !dbg !384

; <label>:15:                                     ; preds = %0
  %16 = load float, float* %2, align 4, !dbg !385
  %17 = fpext float %16 to double, !dbg !385
  %18 = load float, float* %3, align 4, !dbg !387
  %19 = fpext float %18 to double, !dbg !387
  %20 = load float, float* %2, align 4, !dbg !388
  %21 = fpext float %20 to double, !dbg !388
  %22 = load float, float* %3, align 4, !dbg !389
  %23 = fpext float %22 to double, !dbg !389
  %24 = load float, float* %4, align 4, !dbg !390
  %25 = fpext float %24 to double, !dbg !390
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.1, i32 0, i32 0), double %17, double %19, double %21, double %23, double %25), !dbg !391
  br label %40, !dbg !392

; <label>:27:                                     ; preds = %0
  %28 = load float, float* %2, align 4, !dbg !393
  %29 = fpext float %28 to double, !dbg !393
  %30 = load float, float* %3, align 4, !dbg !395
  %31 = fpext float %30 to double, !dbg !395
  %32 = load float, float* %2, align 4, !dbg !396
  %33 = fpext float %32 to double, !dbg !396
  %34 = load float, float* %3, align 4, !dbg !397
  %35 = fpext float %34 to double, !dbg !397
  %36 = load float, float* %4, align 4, !dbg !398
  %37 = fmul float -1.000000e+00, %36, !dbg !399
  %38 = fpext float %37 to double, !dbg !400
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.2, i32 0, i32 0), double %29, double %31, double %33, double %35, double %38), !dbg !401
  br label %40
...
!1 = !DIFile(filename: "gcov/../WA_c/270052_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
...
!368 = !{!10}
!369 = !DILocalVariable(name: "a", scope: !366, file: !1, line: 5, type: !76)
!370 = !DILocation(line: 5, column: 11, scope: !366)
!371 = !DILocalVariable(name: "b", scope: !366, file: !1, line: 5, type: !76)
!372 = !DILocation(line: 5, column: 13, scope: !366)
!373 = !DILocation(line: 7, column: 5, scope: !366)
!374 = !DILocalVariable(name: "area", scope: !366, file: !1, line: 9, type: !76)
!375 = !DILocation(line: 9, column: 11, scope: !366)
!376 = !DILocation(line: 9, column: 28, scope: !366)
!377 = !DILocation(line: 9, column: 27, scope: !366)
!378 = !DILocation(line: 9, column: 30, scope: !366)
!379 = !DILocation(line: 9, column: 29, scope: !366)
!380 = !DILocation(line: 9, column: 18, scope: !366)
!381 = !DILocation(line: 10, column: 8, scope: !382)
!382 = distinct !DILexicalBlock(scope: !366, file: !1, line: 10, column: 8)
!383 = !DILocation(line: 10, column: 12, scope: !382)
!384 = !DILocation(line: 10, column: 8, scope: !366)
!385 = !DILocation(line: 13, column: 74, scope: !386)
!386 = distinct !DILexicalBlock(scope: !382, file: !1, line: 11, column: 5)
!387 = !DILocation(line: 13, column: 76, scope: !386)
!388 = !DILocation(line: 13, column: 78, scope: !386)
!389 = !DILocation(line: 13, column: 80, scope: !386)
!390 = !DILocation(line: 13, column: 82, scope: !386)
!391 = !DILocation(line: 13, column: 9, scope: !386)
!392 = !DILocation(line: 14, column: 5, scope: !386)
!393 = !DILocation(line: 17, column: 73, scope: !394)
!394 = distinct !DILexicalBlock(scope: !382, file: !1, line: 16, column: 5)
!395 = !DILocation(line: 17, column: 75, scope: !394)
!396 = !DILocation(line: 17, column: 77, scope: !394)
!397 = !DILocation(line: 17, column: 79, scope: !394)
!398 = !DILocation(line: 17, column: 84, scope: !394)
!399 = !DILocation(line: 17, column: 83, scope: !394)
!400 = !DILocation(line: 17, column: 81, scope: !394)
!401 = !DILocation(line: 17, column: 9, scope: !394)
!402 = !DILocation(line: 20, column: 5, scope: !366)
