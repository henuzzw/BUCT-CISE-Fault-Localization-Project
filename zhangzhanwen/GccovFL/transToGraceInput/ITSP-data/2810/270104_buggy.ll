; ModuleID = 'gcov/../WA_c/270104_buggy.c'
source_filename = "gcov/../WA_c/270104_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), float* %2, float* %3), !dbg !373
  ...
  %7 = call float @_ZSt3absf(float %6), !dbg !377
  %8 = fpext float %7 to double, !dbg !377
  %9 = fmul double 5.000000e-01, %8, !dbg !378
  %10 = load float, float* %3, align 4, !dbg !379
  %11 = call float @_ZSt3absf(float %10), !dbg !380
  %12 = fpext float %11 to double, !dbg !380
  %13 = fmul double %9, %12, !dbg !381
  %14 = fptrunc double %13 to float, !dbg !382
  store float %14, float* %4, align 4, !dbg !375
  %15 = load float, float* %2, align 4, !dbg !383
  %16 = fpext float %15 to double, !dbg !383
  %17 = load float, float* %3, align 4, !dbg !384
  %18 = fpext float %17 to double, !dbg !384
  %19 = load float, float* %2, align 4, !dbg !385
  %20 = fpext float %19 to double, !dbg !385
  %21 = load float, float* %3, align 4, !dbg !386
  %22 = fpext float %21 to double, !dbg !386
  %23 = load float, float* %4, align 4, !dbg !387
  %24 = fpext float %23 to double, !dbg !387
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.1, i32 0, i32 0), double %16, double %18, double %20, double %22, double %24), !dbg !388
  ret i32 0, !dbg !389
}
...
define linkonce_odr float @_ZSt3absf(float) #3 comdat !dbg !390 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  call void @llvm.dbg.declare(metadata float* %2, metadata !391, metadata !DIExpression()), !dbg !392
  %3 = load float, float* %2, align 4, !dbg !393
  %4 = call float @llvm.fabs.f32(float %3), !dbg !394
  ret float %4, !dbg !395
}
...
!1 = !DIFile(filename: "gcov/../WA_c/270104_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!374 = !DILocalVariable(name: "x", scope: !366, file: !1, line: 7, type: !76)
!375 = !DILocation(line: 7, column: 11, scope: !366)
!376 = !DILocation(line: 7, column: 29, scope: !366)
!377 = !DILocation(line: 7, column: 25, scope: !366)
!378 = !DILocation(line: 7, column: 24, scope: !366)
!379 = !DILocation(line: 7, column: 36, scope: !366)
!380 = !DILocation(line: 7, column: 32, scope: !366)
!381 = !DILocation(line: 7, column: 31, scope: !366)
!382 = !DILocation(line: 7, column: 15, scope: !366)
!383 = !DILocation(line: 8, column: 70, scope: !366)
!384 = !DILocation(line: 8, column: 72, scope: !366)
!385 = !DILocation(line: 8, column: 74, scope: !366)
!386 = !DILocation(line: 8, column: 76, scope: !366)
!387 = !DILocation(line: 8, column: 78, scope: !366)
!388 = !DILocation(line: 8, column: 5, scope: !366)
!389 = !DILocation(line: 10, column: 5, scope: !366)
!390 = distinct !DISubprogram(name: "abs", linkageName: "_ZSt3absf", scope: !5, file: !11, line: 74, type: !81, isLocal: false, isDefinition: true, scopeLine: 75, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!391 = !DILocalVariable(name: "__x", arg: 1, scope: !390, file: !11, line: 74, type: !76)
!392 = !DILocation(line: 74, column: 13, scope: !390)
!393 = !DILocation(line: 75, column: 28, scope: !390)
!394 = !DILocation(line: 75, column: 12, scope: !390)
!395 = !DILocation(line: 75, column: 5, scope: !390)
