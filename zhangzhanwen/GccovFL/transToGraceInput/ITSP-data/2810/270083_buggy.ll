; ModuleID = 'gcov/../WA_c/270083_buggy.c'
source_filename = "gcov/../WA_c/270083_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), float* %2, float* %3), !dbg !375
  ...
  %12 = call double @_ZSt3absd(double %11), !dbg !380
  %13 = fptrunc double %12 to float, !dbg !380
  store float %13, float* %4, align 4, !dbg !381
  %14 = load float, float* %2, align 4, !dbg !382
  %15 = fpext float %14 to double, !dbg !382
  %16 = load float, float* %3, align 4, !dbg !383
  %17 = fpext float %16 to double, !dbg !383
  %18 = load float, float* %2, align 4, !dbg !384
  %19 = fpext float %18 to double, !dbg !384
  %20 = load float, float* %3, align 4, !dbg !385
  %21 = fpext float %20 to double, !dbg !385
  %22 = load float, float* %4, align 4, !dbg !386
  %23 = fpext float %22 to double, !dbg !386
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.1, i32 0, i32 0), double %15, double %17, double %19, double %21, double %23), !dbg !387
  ret i32 0, !dbg !388
}
...
define linkonce_odr double @_ZSt3absd(double) #3 comdat !dbg !389 {
  %2 = alloca double, align 8
  store double %0, double* %2, align 8
  call void @llvm.dbg.declare(metadata double* %2, metadata !390, metadata !DIExpression()), !dbg !391
  %3 = load double, double* %2, align 8, !dbg !392
  %4 = call double @llvm.fabs.f64(double %3), !dbg !393
  ret double %4, !dbg !394
}
...
!1 = !DIFile(filename: "gcov/../WA_c/270083_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!371 = !DILocalVariable(name: "b", scope: !366, file: !1, line: 6, type: !76)
...
!376 = !DILocation(line: 8, column: 18, scope: !366)
!377 = !DILocation(line: 8, column: 17, scope: !366)
!378 = !DILocation(line: 8, column: 20, scope: !366)
!379 = !DILocation(line: 8, column: 19, scope: !366)
!380 = !DILocation(line: 8, column: 10, scope: !366)
!381 = !DILocation(line: 8, column: 9, scope: !366)
!382 = !DILocation(line: 9, column: 75, scope: !366)
!383 = !DILocation(line: 9, column: 77, scope: !366)
!384 = !DILocation(line: 9, column: 79, scope: !366)
!385 = !DILocation(line: 9, column: 81, scope: !366)
!386 = !DILocation(line: 9, column: 83, scope: !366)
!387 = !DILocation(line: 9, column: 5, scope: !366)
!388 = !DILocation(line: 10, column: 5, scope: !366)
!389 = distinct !DISubprogram(name: "abs", linkageName: "_ZSt3absd", scope: !5, file: !11, line: 70, type: !15, isLocal: false, isDefinition: true, scopeLine: 71, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!390 = !DILocalVariable(name: "__x", arg: 1, scope: !389, file: !11, line: 70, type: !17)
!391 = !DILocation(line: 70, column: 14, scope: !389)
!392 = !DILocation(line: 71, column: 27, scope: !389)
!393 = !DILocation(line: 71, column: 12, scope: !389)
!394 = !DILocation(line: 71, column: 5, scope: !389)
