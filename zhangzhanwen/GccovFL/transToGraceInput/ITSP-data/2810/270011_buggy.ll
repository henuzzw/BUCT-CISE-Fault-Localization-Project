; ModuleID = 'gcov/../WA_c/270011_buggy.c'
source_filename = "gcov/../WA_c/270011_buggy.c"
...
define i32 @main() #0 !dbg !7 {
  ...
  %11 = fcmp ogt float %10, 0.000000e+00, !dbg !26
...
; <label>:12:                                     ; preds = %0
  ...
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i32 0, i32 0), double %14, double %16, double %18, double %20, double %22), !dbg !34
  br label %37, !dbg !35
...
; <label>:24:                                     ; preds = %0
  ...
  %34 = fmul float -1.000000e+00, %33, !dbg !42
  %35 = fpext float %34 to double, !dbg !43
  %36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.1, i32 0, i32 0), double %26, double %28, double %30, double %32, double %35), !dbg !44
  br label %37

; <label>:37:                                     ; preds = %24, %12
  ret i32 0, !dbg !45
}
...
!1 = !DIFile(filename: "gcov/../WA_c/270011_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2810")
!2 = !{}
...
!25 = distinct !DILexicalBlock(scope: !7, file: !1, line: 8, column: 8)
!26 = !DILocation(line: 8, column: 12, scope: !25)
!27 = !DILocation(line: 8, column: 8, scope: !7)
!28 = !DILocation(line: 10, column: 73, scope: !29)
!29 = distinct !DILexicalBlock(scope: !25, file: !1, line: 9, column: 5)
!30 = !DILocation(line: 10, column: 75, scope: !29)
!31 = !DILocation(line: 10, column: 77, scope: !29)
!32 = !DILocation(line: 10, column: 79, scope: !29)
!33 = !DILocation(line: 10, column: 81, scope: !29)
!34 = !DILocation(line: 10, column: 9, scope: !29)
!35 = !DILocation(line: 11, column: 5, scope: !29)
!36 = !DILocation(line: 14, column: 73, scope: !37)
!37 = distinct !DILexicalBlock(scope: !25, file: !1, line: 13, column: 5)
!38 = !DILocation(line: 14, column: 75, scope: !37)
!39 = !DILocation(line: 14, column: 77, scope: !37)
!40 = !DILocation(line: 14, column: 79, scope: !37)
!41 = !DILocation(line: 14, column: 86, scope: !37)
!42 = !DILocation(line: 14, column: 85, scope: !37)
!43 = !DILocation(line: 14, column: 81, scope: !37)
!44 = !DILocation(line: 14, column: 9, scope: !37)
