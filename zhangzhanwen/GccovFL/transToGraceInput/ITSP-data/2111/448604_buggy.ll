; ModuleID = 'gcov/../WA_c/448604_buggy.c'
source_filename = "gcov/../WA_c/448604_buggy.c"
...
; <label>:4:                                      ; preds = %29, %0
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %3), !dbg !259
  %6 = icmp ne i32 %5, -1, !dbg !260
  br i1 %6, label %7, label %30, !dbg !258

; <label>:7:                                      ; preds = %4
  store i32 1, i32* %2, align 4, !dbg !261
  %8 = load i32, i32* %3, align 4, !dbg !263
  %9 = icmp sgt i32 %8, 0, !dbg !265
  br i1 %9, label %10, label %27, !dbg !266

; <label>:10:                                     ; preds = %7
  br label %11, !dbg !267

; <label>:11:                                     ; preds = %21, %10
  %12 = load i32, i32* %3, align 4, !dbg !269
  %13 = icmp ne i32 %12, 1, !dbg !270
  br i1 %13, label %14, label %24, !dbg !267

; <label>:14:                                     ; preds = %11
  %15 = load i32, i32* %3, align 4, !dbg !271
  %16 = srem i32 %15, 2, !dbg !274
  %17 = icmp eq i32 %16, 1, !dbg !275
  br i1 %17, label %18, label %21, !dbg !276

; <label>:18:                                     ; preds = %14
  %19 = load i32, i32* %2, align 4, !dbg !277
  %20 = add nsw i32 %19, 1, !dbg !278
  store i32 %20, i32* %2, align 4, !dbg !279
  br label %21, !dbg !280

; <label>:21:                                     ; preds = %18, %14
  %22 = load i32, i32* %3, align 4, !dbg !281
  %23 = sdiv i32 %22, 2, !dbg !282
  store i32 %23, i32* %3, align 4, !dbg !283
  br label %11, !dbg !267, !llvm.loop !284

; <label>:24:                                     ; preds = %11
  %25 = load i32, i32* %2, align 4, !dbg !286
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %25), !dbg !287
  br label %29, !dbg !288

; <label>:27:                                     ; preds = %7
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0)), !dbg !289
  br label %29

; <label>:29:                                     ; preds = %27, %24
  br label %4, !dbg !258, !llvm.loop !290

; <label>:30:                                     ; preds = %4
  %31 = load i32, i32* %1, align 4, !dbg !292
  ret i32 %31, !dbg !292
}
...
!1 = !DIFile(filename: "gcov/../WA_c/448604_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
!2 = !{}
...
!15 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cstdlib", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!58 = !DIFile(filename: "/usr/include/clang/6.0.0/include/stddef.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!213 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!254 = !DILocalVariable(name: "s", scope: !253, file: !1, line: 5, type: !10)
!255 = !DILocation(line: 5, column: 9, scope: !253)
!256 = !DILocalVariable(name: "a", scope: !253, file: !1, line: 5, type: !10)
!257 = !DILocation(line: 5, column: 12, scope: !253)
!258 = !DILocation(line: 6, column: 5, scope: !253)
!259 = !DILocation(line: 6, column: 11, scope: !253)
!260 = !DILocation(line: 6, column: 27, scope: !253)
!261 = !DILocation(line: 8, column: 11, scope: !262)
!262 = distinct !DILexicalBlock(scope: !253, file: !1, line: 7, column: 5)
!263 = !DILocation(line: 9, column: 12, scope: !264)
!264 = distinct !DILexicalBlock(scope: !262, file: !1, line: 9, column: 12)
!265 = !DILocation(line: 9, column: 14, scope: !264)
!266 = !DILocation(line: 9, column: 12, scope: !262)
!267 = !DILocation(line: 11, column: 13, scope: !268)
!268 = distinct !DILexicalBlock(scope: !264, file: !1, line: 10, column: 9)
!269 = !DILocation(line: 11, column: 19, scope: !268)
!270 = !DILocation(line: 11, column: 21, scope: !268)
!271 = !DILocation(line: 13, column: 20, scope: !272)
!272 = distinct !DILexicalBlock(scope: !273, file: !1, line: 13, column: 20)
!273 = distinct !DILexicalBlock(scope: !268, file: !1, line: 12, column: 13)
!274 = !DILocation(line: 13, column: 22, scope: !272)
!275 = !DILocation(line: 13, column: 26, scope: !272)
!276 = !DILocation(line: 13, column: 20, scope: !273)
!277 = !DILocation(line: 14, column: 25, scope: !272)
!278 = !DILocation(line: 14, column: 27, scope: !272)
!279 = !DILocation(line: 14, column: 23, scope: !272)
!280 = !DILocation(line: 14, column: 21, scope: !272)
!281 = !DILocation(line: 15, column: 21, scope: !273)
!282 = !DILocation(line: 15, column: 23, scope: !273)
!283 = !DILocation(line: 15, column: 19, scope: !273)
!284 = distinct !{!284, !267, !285}
!285 = !DILocation(line: 16, column: 13, scope: !268)
!286 = !DILocation(line: 17, column: 28, scope: !268)
!287 = !DILocation(line: 17, column: 13, scope: !268)
!288 = !DILocation(line: 18, column: 9, scope: !268)
!289 = !DILocation(line: 20, column: 13, scope: !264)
!290 = distinct !{!290, !258, !291}
!291 = !DILocation(line: 21, column: 5, scope: !253)
!292 = !DILocation(line: 22, column: 1, scope: !253)
