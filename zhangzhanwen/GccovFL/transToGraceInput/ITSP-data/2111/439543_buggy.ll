; ModuleID = 'gcov/../WA_c/439543_buggy.c'
source_filename = "gcov/../WA_c/439543_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  store i32 0, i32* %2, align 4, !dbg !370
  ...
  store i32 0, i32* %4, align 4, !dbg !374
  call void @llvm.dbg.declare(metadata i32* %5, metadata !375, metadata !DIExpression()), !dbg !376
  br label %6, !dbg !377

; <label>:6:                                      ; preds = %31, %0
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %2), !dbg !378
  %8 = icmp ne i32 %7, -1, !dbg !379
  br i1 %8, label %9, label %34, !dbg !377

; <label>:9:                                      ; preds = %6
  store i32 0, i32* %4, align 4, !dbg !380
  store i32 0, i32* %3, align 4, !dbg !382
  br label %10, !dbg !384

; <label>:10:                                     ; preds = %28, %9
  %11 = load i32, i32* %3, align 4, !dbg !385
  %12 = icmp sle i32 %11, 1000, !dbg !387
  br i1 %12, label %13, label %31, !dbg !388

; <label>:13:                                     ; preds = %10
  %14 = load i32, i32* %2, align 4, !dbg !389
  %15 = srem i32 %14, 2, !dbg !391
  store i32 %15, i32* %5, align 4, !dbg !392
  %16 = load i32, i32* %2, align 4, !dbg !393
  %17 = sdiv i32 %16, 2, !dbg !394
  store i32 %17, i32* %2, align 4, !dbg !395
  %18 = load i32, i32* %5, align 4, !dbg !396
  %19 = icmp eq i32 %18, 1, !dbg !398
  br i1 %19, label %20, label %23, !dbg !399

; <label>:20:                                     ; preds = %13
  %21 = load i32, i32* %4, align 4, !dbg !400
  %22 = add nsw i32 %21, -1, !dbg !400
  store i32 %22, i32* %4, align 4, !dbg !400
  br label %23, !dbg !401

; <label>:23:                                     ; preds = %20, %13
  %24 = load i32, i32* %2, align 4, !dbg !402
  %25 = icmp eq i32 %24, 0, !dbg !404
  br i1 %25, label %26, label %27, !dbg !405
...
; <label>:28:                                     ; preds = %27
  %29 = load i32, i32* %3, align 4, !dbg !408
  %30 = add nsw i32 %29, 1, !dbg !408
  store i32 %30, i32* %3, align 4, !dbg !408
  br label %10, !dbg !409, !llvm.loop !410

; <label>:31:                                     ; preds = %26, %10
  %32 = load i32, i32* %4, align 4, !dbg !412
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %32), !dbg !413
  br label %6, !dbg !377, !llvm.loop !414

; <label>:34:                                     ; preds = %6
  %35 = load i32, i32* %1, align 4, !dbg !416
  ret i32 %35, !dbg !416
}
...
!1 = !DIFile(filename: "gcov/../WA_c/439543_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
!2 = !{}
...
!7 = !DIFile(filename: "/usr/include/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !10}
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/bits/std_abs.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
...
!368 = !{!10}
!369 = !DILocalVariable(name: "b", scope: !366, file: !1, line: 5, type: !10)
!370 = !DILocation(line: 5, column: 9, scope: !366)
!371 = !DILocalVariable(name: "i", scope: !366, file: !1, line: 5, type: !10)
!372 = !DILocation(line: 5, column: 16, scope: !366)
!373 = !DILocalVariable(name: "c", scope: !366, file: !1, line: 5, type: !10)
!374 = !DILocation(line: 5, column: 19, scope: !366)
!375 = !DILocalVariable(name: "d", scope: !366, file: !1, line: 5, type: !10)
!376 = !DILocation(line: 5, column: 26, scope: !366)
!377 = !DILocation(line: 6, column: 5, scope: !366)
!378 = !DILocation(line: 6, column: 11, scope: !366)
!379 = !DILocation(line: 6, column: 27, scope: !366)
!380 = !DILocation(line: 8, column: 11, scope: !381)
!381 = distinct !DILexicalBlock(scope: !366, file: !1, line: 7, column: 5)
!382 = !DILocation(line: 9, column: 15, scope: !383)
!383 = distinct !DILexicalBlock(scope: !381, file: !1, line: 9, column: 9)
!384 = !DILocation(line: 9, column: 13, scope: !383)
!385 = !DILocation(line: 9, column: 20, scope: !386)
!386 = distinct !DILexicalBlock(scope: !383, file: !1, line: 9, column: 9)
!387 = !DILocation(line: 9, column: 22, scope: !386)
!388 = !DILocation(line: 9, column: 9, scope: !383)
!389 = !DILocation(line: 11, column: 17, scope: !390)
!390 = distinct !DILexicalBlock(scope: !386, file: !1, line: 10, column: 9)
!391 = !DILocation(line: 11, column: 19, scope: !390)
!392 = !DILocation(line: 11, column: 15, scope: !390)
!393 = !DILocation(line: 12, column: 17, scope: !390)
!394 = !DILocation(line: 12, column: 19, scope: !390)
!395 = !DILocation(line: 12, column: 15, scope: !390)
!396 = !DILocation(line: 13, column: 16, scope: !397)
!397 = distinct !DILexicalBlock(scope: !390, file: !1, line: 13, column: 16)
!398 = !DILocation(line: 13, column: 18, scope: !397)
!399 = !DILocation(line: 13, column: 16, scope: !390)
!400 = !DILocation(line: 14, column: 18, scope: !397)
!401 = !DILocation(line: 14, column: 17, scope: !397)
!402 = !DILocation(line: 15, column: 16, scope: !403)
!403 = distinct !DILexicalBlock(scope: !390, file: !1, line: 15, column: 16)
!404 = !DILocation(line: 15, column: 18, scope: !403)
!405 = !DILocation(line: 15, column: 16, scope: !390)
!406 = !DILocation(line: 16, column: 17, scope: !403)
!407 = !DILocation(line: 17, column: 9, scope: !390)
!408 = !DILocation(line: 9, column: 32, scope: !386)
!409 = !DILocation(line: 9, column: 9, scope: !386)
!410 = distinct !{!410, !388, !411}
!411 = !DILocation(line: 17, column: 9, scope: !383)
!412 = !DILocation(line: 18, column: 24, scope: !381)
!413 = !DILocation(line: 18, column: 9, scope: !381)
!414 = distinct !{!414, !377, !415}
!415 = !DILocation(line: 19, column: 5, scope: !366)
!416 = !DILocation(line: 20, column: 1, scope: !366)
