; ModuleID = 'gcov/../WA_c/440279_buggy.c'
source_filename = "gcov/../WA_c/440279_buggy.c"
...
; <label>:4:                                      ; preds = %23, %0
  %5 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %2), !dbg !374
  %6 = icmp ne i32 %5, -1, !dbg !375
  br i1 %6, label %7, label %26, !dbg !373
...
; <label>:8:                                      ; preds = %20, %7
  %9 = load i32, i32* %2, align 4, !dbg !379
  %10 = icmp ne i32 %9, 0, !dbg !379
  br i1 %10, label %11, label %23, !dbg !378

; <label>:11:                                     ; preds = %8
  %12 = load i32, i32* %3, align 4, !dbg !380
  %13 = add nsw i32 %12, 1, !dbg !380
  store i32 %13, i32* %3, align 4, !dbg !380
  %14 = load i32, i32* %2, align 4, !dbg !382
  %15 = srem i32 %14, 2, !dbg !384
  %16 = icmp eq i32 %15, 1, !dbg !385
  br i1 %16, label %17, label %20, !dbg !386

; <label>:17:                                     ; preds = %11
  %18 = load i32, i32* %3, align 4, !dbg !387
  %19 = add nsw i32 %18, 1, !dbg !387
  store i32 %19, i32* %3, align 4, !dbg !387
  br label %20, !dbg !388

; <label>:20:                                     ; preds = %17, %11
  %21 = load i32, i32* %2, align 4, !dbg !389
  %22 = sdiv i32 %21, 2, !dbg !389
  store i32 %22, i32* %2, align 4, !dbg !389
  br label %8, !dbg !378, !llvm.loop !390

; <label>:23:                                     ; preds = %8
  %24 = load i32, i32* %3, align 4, !dbg !392
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %24), !dbg !393
  br label %4, !dbg !373, !llvm.loop !394

; <label>:26:                                     ; preds = %4
  %27 = load i32, i32* %1, align 4, !dbg !396
  ret i32 %27, !dbg !396
}
...
!1 = !DIFile(filename: "gcov/../WA_c/440279_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2111")
!2 = !{}
...
!368 = !{!10}
!369 = !DILocalVariable(name: "n", scope: !366, file: !1, line: 5, type: !10)
!370 = !DILocation(line: 5, column: 9, scope: !366)
!371 = !DILocalVariable(name: "count", scope: !366, file: !1, line: 5, type: !10)
...
!375 = !DILocation(line: 6, column: 27, scope: !366)
!376 = !DILocation(line: 8, column: 15, scope: !377)
!377 = distinct !DILexicalBlock(scope: !366, file: !1, line: 7, column: 5)
!378 = !DILocation(line: 9, column: 9, scope: !377)
!379 = !DILocation(line: 9, column: 15, scope: !377)
!380 = !DILocation(line: 11, column: 15, scope: !381)
!381 = distinct !DILexicalBlock(scope: !377, file: !1, line: 10, column: 9)
!382 = !DILocation(line: 12, column: 17, scope: !383)
!383 = distinct !DILexicalBlock(scope: !381, file: !1, line: 12, column: 17)
!384 = !DILocation(line: 12, column: 19, scope: !383)
!385 = !DILocation(line: 12, column: 23, scope: !383)
!386 = !DILocation(line: 12, column: 17, scope: !381)
!387 = !DILocation(line: 13, column: 22, scope: !383)
!388 = !DILocation(line: 13, column: 17, scope: !383)
!389 = !DILocation(line: 14, column: 15, scope: !381)
!390 = distinct !{!390, !378, !391}
!391 = !DILocation(line: 15, column: 9, scope: !377)
!392 = !DILocation(line: 16, column: 24, scope: !377)
!393 = !DILocation(line: 16, column: 9, scope: !377)
!394 = distinct !{!394, !373, !395}
!395 = !DILocation(line: 17, column: 5, scope: !366)
!396 = !DILocation(line: 19, column: 1, scope: !366)
