; ModuleID = 'gcov/../WA_c/278324_buggy.c'
source_filename = "gcov/../WA_c/278324_buggy.c"
...
define i32 @main() #3 !dbg !414 {
  ...
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %2), !dbg !421
  %5 = load i32, i32* %2, align 4, !dbg !422
  %6 = icmp eq i32 %5, 1, !dbg !424
  br i1 %6, label %7, label %11, !dbg !425

; <label>:7:                                      ; preds = %0
  %8 = load i32, i32* %2, align 4, !dbg !426
  %9 = add nsw i32 %8, 1, !dbg !428
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32 %9), !dbg !429
  br label %11, !dbg !430

; <label>:11:                                     ; preds = %7, %0
  %12 = load i32, i32* %2, align 4, !dbg !431
  store i32 %12, i32* %3, align 4, !dbg !433
  br label %13, !dbg !434

; <label>:13:                                     ; preds = %25, %11
  %14 = load i32, i32* %3, align 4, !dbg !435
  %15 = load i32, i32* %2, align 4, !dbg !437
  %16 = load i32, i32* %2, align 4, !dbg !438
  %17 = mul nsw i32 %15, %16, !dbg !439
  %18 = icmp sle i32 %14, %17, !dbg !440
  br i1 %18, label %19, label %28, !dbg !441

; <label>:19:                                     ; preds = %13
  %20 = load i32, i32* %3, align 4, !dbg !442
  %21 = call i32 @_Z11check_primei(i32 %20), !dbg !445
  %22 = icmp ne i32 %21, 0, !dbg !445
  br i1 %22, label %23, label %24, !dbg !446
...
; <label>:25:                                     ; preds = %24
  %26 = load i32, i32* %3, align 4, !dbg !450
  %27 = add nsw i32 %26, 1, !dbg !450
  store i32 %27, i32* %3, align 4, !dbg !450
  br label %13, !dbg !451, !llvm.loop !452

; <label>:28:                                     ; preds = %23, %13
  %29 = load i32, i32* %3, align 4, !dbg !454
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32 %29), !dbg !455
  ret i32 0, !dbg !456
}
...
!1 = !DIFile(filename: "gcov/../WA_c/278324_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
!2 = !{}
...
!7 = !DIFile(filename: "/usr/include/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !10}
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/bits/std_abs.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
...
!369 = !DILocalVariable(name: "i", scope: !366, file: !1, line: 5, type: !10)
...
!400 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/ext/type_traits.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2870")
...
!414 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 17, type: !415, isLocal: false, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!415 = !DISubroutineType(types: !416)
!416 = !{!10}
!417 = !DILocalVariable(name: "N", scope: !414, file: !1, line: 20, type: !10)
!418 = !DILocation(line: 20, column: 9, scope: !414)
!419 = !DILocalVariable(name: "i", scope: !414, file: !1, line: 20, type: !10)
!420 = !DILocation(line: 20, column: 11, scope: !414)
!421 = !DILocation(line: 21, column: 5, scope: !414)
!422 = !DILocation(line: 22, column: 8, scope: !423)
!423 = distinct !DILexicalBlock(scope: !414, file: !1, line: 22, column: 8)
!424 = !DILocation(line: 22, column: 9, scope: !423)
!425 = !DILocation(line: 22, column: 8, scope: !414)
!426 = !DILocation(line: 24, column: 21, scope: !427)
!427 = distinct !DILexicalBlock(scope: !423, file: !1, line: 23, column: 5)
!428 = !DILocation(line: 24, column: 22, scope: !427)
!429 = !DILocation(line: 24, column: 9, scope: !427)
!430 = !DILocation(line: 25, column: 5, scope: !427)
!431 = !DILocation(line: 26, column: 11, scope: !432)
!432 = distinct !DILexicalBlock(scope: !414, file: !1, line: 26, column: 5)
!433 = !DILocation(line: 26, column: 10, scope: !432)
!434 = !DILocation(line: 26, column: 9, scope: !432)
!435 = !DILocation(line: 26, column: 14, scope: !436)
!436 = distinct !DILexicalBlock(scope: !432, file: !1, line: 26, column: 5)
!437 = !DILocation(line: 26, column: 17, scope: !436)
!438 = !DILocation(line: 26, column: 19, scope: !436)
!439 = !DILocation(line: 26, column: 18, scope: !436)
!440 = !DILocation(line: 26, column: 15, scope: !436)
!441 = !DILocation(line: 26, column: 5, scope: !432)
!442 = !DILocation(line: 28, column: 25, scope: !443)
!443 = distinct !DILexicalBlock(scope: !444, file: !1, line: 28, column: 13)
!444 = distinct !DILexicalBlock(scope: !436, file: !1, line: 27, column: 5)
!445 = !DILocation(line: 28, column: 13, scope: !443)
!446 = !DILocation(line: 28, column: 13, scope: !444)
!447 = !DILocation(line: 30, column: 13, scope: !448)
!448 = distinct !DILexicalBlock(scope: !443, file: !1, line: 29, column: 9)
!449 = !DILocation(line: 32, column: 5, scope: !444)
!450 = !DILocation(line: 26, column: 23, scope: !436)
!451 = !DILocation(line: 26, column: 5, scope: !436)
!452 = distinct !{!452, !441, !453}
!453 = !DILocation(line: 32, column: 5, scope: !432)
!454 = !DILocation(line: 33, column: 17, scope: !414)
!455 = !DILocation(line: 33, column: 5, scope: !414)
!456 = !DILocation(line: 34, column: 5, scope: !414)
