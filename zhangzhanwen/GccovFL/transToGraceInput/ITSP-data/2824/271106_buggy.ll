; ModuleID = 'gcov/../WA_c/271106_buggy.c'
source_filename = "gcov/../WA_c/271106_buggy.c"
...
define i32 @main() #0 !dbg !7 {
  ...
  br i1 %6, label %7, label %20, !dbg !18
...
; <label>:20:                                     ; preds = %0
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i32 0, i32 0)), !dbg !35
  br label %22
...
!1 = !DIFile(filename: "gcov/../WA_c/271106_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2824")
!2 = !{}
...
!22 = !DILocation(line: 9, column: 15, scope: !20)
!23 = !DILocation(line: 9, column: 19, scope: !20)
!24 = !DILocation(line: 9, column: 23, scope: !20)
!25 = !DILocation(line: 9, column: 26, scope: !20)
!26 = !DILocation(line: 9, column: 27, scope: !20)
...
!34 = !DILocation(line: 17, column: 5, scope: !21)
!35 = !DILocation(line: 20, column: 9, scope: !36)
!36 = distinct !DILexicalBlock(scope: !15, file: !1, line: 19, column: 5)
