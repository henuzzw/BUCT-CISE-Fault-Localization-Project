; ModuleID = 'gcov/../WA_c/271100_buggy.c'
source_filename = "gcov/../WA_c/271100_buggy.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1 = private unnamed_addr constant [14 x i8] c"Not Leap Year\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"Leap Year\00", align 1
...
; <label>:11:                                     ; preds = %7
  ...
  br i1 %14, label %17, label %15, !dbg !28

; <label>:15:                                     ; preds = %11
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0)), !dbg !29
  br label %17, !dbg !31

; <label>:17:                                     ; preds = %15, %11, %7
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0)), !dbg !32
  br label %21, !dbg !33

; <label>:19:                                     ; preds = %0
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0)), !dbg !34
  br label %21
...
!1 = !DIFile(filename: "gcov/../WA_c/271100_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2824")
!2 = !{}
...
!23 = !DILocation(line: 9, column: 21, scope: !20)
!24 = !DILocation(line: 9, column: 26, scope: !20)
!25 = !DILocation(line: 9, column: 31, scope: !20)
!26 = !DILocation(line: 9, column: 35, scope: !20)
!27 = !DILocation(line: 9, column: 39, scope: !20)
...
!32 = !DILocation(line: 13, column: 9, scope: !21)
!33 = !DILocation(line: 14, column: 5, scope: !21)
!34 = !DILocation(line: 17, column: 9, scope: !35)
!35 = distinct !DILexicalBlock(scope: !15, file: !1, line: 16, column: 5)
!36 = !DILocation(line: 21, column: 5, scope: !7)
