; ModuleID = 'gcov/../WA_c/444226_buggy.c'
source_filename = "gcov/../WA_c/444226_buggy.c"
...
define i32 @main() #0 !dbg !253 {
  ...
  call void @llvm.dbg.declare(metadata i32* %2, metadata !254, metadata !DIExpression()), !dbg !255
  call void @llvm.dbg.declare(metadata i32* %3, metadata !256, metadata !DIExpression()), !dbg !257
  call void @llvm.dbg.declare(metadata i8* %4, metadata !258, metadata !DIExpression()), !dbg !259
  br label %5, !dbg !260

; <label>:5:                                      ; preds = %50, %0
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* %4), !dbg !261
  %7 = icmp ne i32 %6, -1, !dbg !262
  br i1 %7, label %8, label %52, !dbg !260

; <label>:8:                                      ; preds = %5
  br label %9, !dbg !263

; <label>:9:                                      ; preds = %23, %8
  %10 = load i8, i8* %4, align 1, !dbg !265
  %11 = sext i8 %10 to i32, !dbg !265
  %12 = icmp slt i32 %11, 65, !dbg !266
  br i1 %12, label %17, label %13, !dbg !267

; <label>:13:                                     ; preds = %9
  %14 = load i8, i8* %4, align 1, !dbg !268
  %15 = sext i8 %14 to i32, !dbg !268
  %16 = icmp sgt i32 %15, 90, !dbg !269
  br label %17, !dbg !267

; <label>:17:                                     ; preds = %13, %9
  %18 = phi i1 [ true, %9 ], [ %16, %13 ]
  br i1 %18, label %19, label %24, !dbg !263

; <label>:19:                                     ; preds = %17
  %20 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* %4), !dbg !270
  %21 = icmp eq i32 %20, -1, !dbg !272
  br i1 %21, label %22, label %23, !dbg !273
...
; <label>:23:                                     ; preds = %19
  br label %9, !dbg !263, !llvm.loop !275

; <label>:24:                                     ; preds = %17
  store i32 1, i32* %2, align 4, !dbg !277
  br label %25, !dbg !279

; <label>:25:                                     ; preds = %47, %24
  %26 = load i32, i32* %2, align 4, !dbg !280
  %27 = load i8, i8* %4, align 1, !dbg !282
  %28 = sext i8 %27 to i32, !dbg !282
  %29 = sub nsw i32 %28, 65, !dbg !283
  %30 = icmp sle i32 %26, %29, !dbg !284
  br i1 %30, label %31, label %50, !dbg !285
...
; <label>:32:                                     ; preds = %42, %31
  %33 = load i32, i32* %3, align 4, !dbg !290
  %34 = load i32, i32* %2, align 4, !dbg !292
  %35 = icmp sle i32 %33, %34, !dbg !293
  br i1 %35, label %36, label %45, !dbg !294

; <label>:36:                                     ; preds = %32
  %37 = load i8, i8* %4, align 1, !dbg !295
  %38 = sext i8 %37 to i32, !dbg !295
  %39 = load i32, i32* %3, align 4, !dbg !297
  %40 = sub nsw i32 %38, %39, !dbg !298
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32 %40), !dbg !299
  br label %42, !dbg !300

; <label>:42:                                     ; preds = %36
  %43 = load i32, i32* %3, align 4, !dbg !301
  %44 = add nsw i32 %43, 1, !dbg !301
  store i32 %44, i32* %3, align 4, !dbg !301
  br label %32, !dbg !302, !llvm.loop !303

; <label>:45:                                     ; preds = %32
  %46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)), !dbg !305
  br label %47, !dbg !306

; <label>:47:                                     ; preds = %45
  %48 = load i32, i32* %2, align 4, !dbg !307
  %49 = add nsw i32 %48, 1, !dbg !307
  store i32 %49, i32* %2, align 4, !dbg !307
  br label %25, !dbg !308, !llvm.loop !309

; <label>:50:                                     ; preds = %25
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)), !dbg !311
  br label %5, !dbg !260, !llvm.loop !312

; <label>:52:                                     ; preds = %5
  store i32 0, i32* %1, align 4, !dbg !314
  br label %53, !dbg !314

; <label>:53:                                     ; preds = %52, %22
  %54 = load i32, i32* %1, align 4, !dbg !315
  ret i32 %54, !dbg !315
}
...
!1 = !DIFile(filename: "gcov/../WA_c/444226_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1912")
!2 = !{}
...
!253 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 3, type: !121, isLocal: false, isDefinition: true, scopeLine: 4, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!254 = !DILocalVariable(name: "i", scope: !253, file: !1, line: 5, type: !10)
!255 = !DILocation(line: 5, column: 9, scope: !253)
!256 = !DILocalVariable(name: "j", scope: !253, file: !1, line: 5, type: !10)
!257 = !DILocation(line: 5, column: 12, scope: !253)
!258 = !DILocalVariable(name: "num", scope: !253, file: !1, line: 6, type: !41)
!259 = !DILocation(line: 6, column: 10, scope: !253)
!260 = !DILocation(line: 7, column: 5, scope: !253)
!261 = !DILocation(line: 7, column: 11, scope: !253)
!262 = !DILocation(line: 7, column: 29, scope: !253)
!263 = !DILocation(line: 9, column: 9, scope: !264)
!264 = distinct !DILexicalBlock(scope: !253, file: !1, line: 8, column: 5)
!265 = !DILocation(line: 9, column: 15, scope: !264)
!266 = !DILocation(line: 9, column: 19, scope: !264)
!267 = !DILocation(line: 9, column: 25, scope: !264)
!268 = !DILocation(line: 9, column: 28, scope: !264)
!269 = !DILocation(line: 9, column: 32, scope: !264)
!270 = !DILocation(line: 9, column: 42, scope: !271)
!271 = distinct !DILexicalBlock(scope: !264, file: !1, line: 9, column: 42)
!272 = !DILocation(line: 9, column: 60, scope: !271)
!273 = !DILocation(line: 9, column: 42, scope: !264)
!274 = !DILocation(line: 9, column: 68, scope: !271)
!275 = distinct !{!275, !263, !276}
!276 = !DILocation(line: 9, column: 75, scope: !264)
!277 = !DILocation(line: 10, column: 15, scope: !278)
!278 = distinct !DILexicalBlock(scope: !264, file: !1, line: 10, column: 9)
!279 = !DILocation(line: 10, column: 13, scope: !278)
!280 = !DILocation(line: 10, column: 20, scope: !281)
!281 = distinct !DILexicalBlock(scope: !278, file: !1, line: 10, column: 9)
!282 = !DILocation(line: 10, column: 25, scope: !281)
!283 = !DILocation(line: 10, column: 29, scope: !281)
!284 = !DILocation(line: 10, column: 22, scope: !281)
!285 = !DILocation(line: 10, column: 9, scope: !278)
!286 = !DILocation(line: 12, column: 19, scope: !287)
!287 = distinct !DILexicalBlock(scope: !288, file: !1, line: 12, column: 13)
!288 = distinct !DILexicalBlock(scope: !281, file: !1, line: 11, column: 9)
!289 = !DILocation(line: 12, column: 17, scope: !287)
!290 = !DILocation(line: 12, column: 24, scope: !291)
!291 = distinct !DILexicalBlock(scope: !287, file: !1, line: 12, column: 13)
!292 = !DILocation(line: 12, column: 29, scope: !291)
!293 = !DILocation(line: 12, column: 26, scope: !291)
!294 = !DILocation(line: 12, column: 13, scope: !287)
!295 = !DILocation(line: 14, column: 30, scope: !296)
!296 = distinct !DILexicalBlock(scope: !291, file: !1, line: 13, column: 13)
!297 = !DILocation(line: 14, column: 36, scope: !296)
!298 = !DILocation(line: 14, column: 34, scope: !296)
!299 = !DILocation(line: 14, column: 17, scope: !296)
!300 = !DILocation(line: 15, column: 13, scope: !296)
!301 = !DILocation(line: 12, column: 33, scope: !291)
!302 = !DILocation(line: 12, column: 13, scope: !291)
!303 = distinct !{!303, !294, !304}
!304 = !DILocation(line: 15, column: 13, scope: !287)
!305 = !DILocation(line: 16, column: 13, scope: !288)
!306 = !DILocation(line: 17, column: 9, scope: !288)
!307 = !DILocation(line: 10, column: 37, scope: !281)
!308 = !DILocation(line: 10, column: 9, scope: !281)
!309 = distinct !{!309, !285, !310}
!310 = !DILocation(line: 17, column: 9, scope: !278)
!311 = !DILocation(line: 18, column: 9, scope: !264)
!312 = distinct !{!312, !260, !313}
!313 = !DILocation(line: 19, column: 5, scope: !253)
!314 = !DILocation(line: 20, column: 5, scope: !253)
!315 = !DILocation(line: 21, column: 1, scope: !253)
