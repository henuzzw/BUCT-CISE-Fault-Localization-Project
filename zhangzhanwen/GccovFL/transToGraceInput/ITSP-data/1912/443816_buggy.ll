; ModuleID = 'gcov/../WA_c/443816_buggy.c'
source_filename = "gcov/../WA_c/443816_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  call void @llvm.dbg.declare(metadata i8* %2, metadata !369, metadata !DIExpression()), !dbg !370
  call void @llvm.dbg.declare(metadata i8* %3, metadata !371, metadata !DIExpression()), !dbg !372
...
; <label>:7:                                      ; preds = %46, %0
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8* %2), !dbg !380
  %9 = icmp ne i32 %8, -1, !dbg !381
  br i1 %9, label %10, label %47, !dbg !379

; <label>:10:                                     ; preds = %7
  %11 = load i8, i8* %2, align 1, !dbg !382
  %12 = sext i8 %11 to i32, !dbg !382
  %13 = sub nsw i32 %12, 65, !dbg !384
  %14 = add nsw i32 %13, 1, !dbg !385
  store i32 %14, i32* %5, align 4, !dbg !386
  store i32 0, i32* %4, align 4, !dbg !387
  br label %15, !dbg !389

; <label>:15:                                     ; preds = %43, %10
  %16 = load i32, i32* %4, align 4, !dbg !390
  %17 = load i32, i32* %5, align 4, !dbg !392
  %18 = icmp slt i32 %16, %17, !dbg !393
  br i1 %18, label %19, label %46, !dbg !394

; <label>:19:                                     ; preds = %15
  %20 = load i8, i8* %2, align 1, !dbg !395
  store i8 %20, i8* %3, align 1, !dbg !397
  store i32 0, i32* %6, align 4, !dbg !398
  br label %21, !dbg !400

; <label>:21:                                     ; preds = %31, %19
  %22 = load i32, i32* %6, align 4, !dbg !401
  %23 = load i32, i32* %4, align 4, !dbg !403
  %24 = icmp sle i32 %22, %23, !dbg !404
  br i1 %24, label %25, label %34, !dbg !405

; <label>:25:                                     ; preds = %21
  %26 = load i8, i8* %3, align 1, !dbg !406
  %27 = sext i8 %26 to i32, !dbg !406
  %28 = load i32, i32* %6, align 4, !dbg !407
  %29 = sub nsw i32 %27, %28, !dbg !408
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %29), !dbg !409
  br label %31, !dbg !409

; <label>:31:                                     ; preds = %25
  %32 = load i32, i32* %6, align 4, !dbg !410
  %33 = add nsw i32 %32, 1, !dbg !410
  store i32 %33, i32* %6, align 4, !dbg !410
  br label %21, !dbg !411, !llvm.loop !412

; <label>:34:                                     ; preds = %21
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0)), !dbg !414
  %36 = load i32, i32* %4, align 4, !dbg !415
  %37 = load i32, i32* %5, align 4, !dbg !417
  %38 = sub nsw i32 %37, 1, !dbg !418
  %39 = icmp eq i32 %36, %38, !dbg !419
  br i1 %39, label %40, label %42, !dbg !420

; <label>:40:                                     ; preds = %34
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0)), !dbg !421
  br label %42, !dbg !421
...
; <label>:43:                                     ; preds = %42
  %44 = load i32, i32* %4, align 4, !dbg !423
  %45 = add nsw i32 %44, 1, !dbg !423
  store i32 %45, i32* %4, align 4, !dbg !423
  br label %15, !dbg !424, !llvm.loop !425

; <label>:46:                                     ; preds = %15
  br label %7, !dbg !379, !llvm.loop !427
...
!1 = !DIFile(filename: "gcov/../WA_c/443816_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1912")
!2 = !{}
...
!368 = !{!10}
!369 = !DILocalVariable(name: "a", scope: !366, file: !1, line: 5, type: !256)
!370 = !DILocation(line: 5, column: 10, scope: !366)
!371 = !DILocalVariable(name: "b", scope: !366, file: !1, line: 5, type: !256)
!372 = !DILocation(line: 5, column: 13, scope: !366)
!373 = !DILocalVariable(name: "i", scope: !366, file: !1, line: 6, type: !10)
!374 = !DILocation(line: 6, column: 9, scope: !366)
!375 = !DILocalVariable(name: "n", scope: !366, file: !1, line: 6, type: !10)
!376 = !DILocation(line: 6, column: 12, scope: !366)
!377 = !DILocalVariable(name: "j", scope: !366, file: !1, line: 6, type: !10)
!378 = !DILocation(line: 6, column: 15, scope: !366)
!379 = !DILocation(line: 7, column: 5, scope: !366)
!380 = !DILocation(line: 7, column: 11, scope: !366)
!381 = !DILocation(line: 7, column: 27, scope: !366)
!382 = !DILocation(line: 9, column: 13, scope: !383)
!383 = distinct !DILexicalBlock(scope: !366, file: !1, line: 8, column: 5)
!384 = !DILocation(line: 9, column: 15, scope: !383)
!385 = !DILocation(line: 9, column: 21, scope: !383)
!386 = !DILocation(line: 9, column: 11, scope: !383)
!387 = !DILocation(line: 10, column: 15, scope: !388)
!388 = distinct !DILexicalBlock(scope: !383, file: !1, line: 10, column: 9)
!389 = !DILocation(line: 10, column: 13, scope: !388)
!390 = !DILocation(line: 10, column: 20, scope: !391)
!391 = distinct !DILexicalBlock(scope: !388, file: !1, line: 10, column: 9)
!392 = !DILocation(line: 10, column: 24, scope: !391)
!393 = !DILocation(line: 10, column: 22, scope: !391)
!394 = !DILocation(line: 10, column: 9, scope: !388)
!395 = !DILocation(line: 12, column: 17, scope: !396)
!396 = distinct !DILexicalBlock(scope: !391, file: !1, line: 11, column: 9)
!397 = !DILocation(line: 12, column: 15, scope: !396)
!398 = !DILocation(line: 13, column: 19, scope: !399)
!399 = distinct !DILexicalBlock(scope: !396, file: !1, line: 13, column: 13)
!400 = !DILocation(line: 13, column: 17, scope: !399)
!401 = !DILocation(line: 13, column: 24, scope: !402)
!402 = distinct !DILexicalBlock(scope: !399, file: !1, line: 13, column: 13)
!403 = !DILocation(line: 13, column: 29, scope: !402)
!404 = !DILocation(line: 13, column: 26, scope: !402)
!405 = !DILocation(line: 13, column: 13, scope: !399)
!406 = !DILocation(line: 14, column: 32, scope: !402)
!407 = !DILocation(line: 14, column: 36, scope: !402)
!408 = !DILocation(line: 14, column: 34, scope: !402)
!409 = !DILocation(line: 14, column: 17, scope: !402)
!410 = !DILocation(line: 13, column: 33, scope: !402)
!411 = !DILocation(line: 13, column: 13, scope: !402)
!412 = distinct !{!412, !405, !413}
!413 = !DILocation(line: 14, column: 37, scope: !399)
!414 = !DILocation(line: 15, column: 13, scope: !396)
!415 = !DILocation(line: 16, column: 16, scope: !416)
!416 = distinct !DILexicalBlock(scope: !396, file: !1, line: 16, column: 16)
!417 = !DILocation(line: 16, column: 21, scope: !416)
!418 = !DILocation(line: 16, column: 23, scope: !416)
!419 = !DILocation(line: 16, column: 18, scope: !416)
!420 = !DILocation(line: 16, column: 16, scope: !396)
!421 = !DILocation(line: 17, column: 17, scope: !416)
!422 = !DILocation(line: 18, column: 9, scope: !396)
!423 = !DILocation(line: 10, column: 28, scope: !391)
!424 = !DILocation(line: 10, column: 9, scope: !391)
!425 = distinct !{!425, !394, !426}
!426 = !DILocation(line: 18, column: 9, scope: !388)
!427 = distinct !{!427, !379, !428}
!428 = !DILocation(line: 19, column: 5, scope: !366)
!429 = !DILocation(line: 20, column: 5, scope: !366)
