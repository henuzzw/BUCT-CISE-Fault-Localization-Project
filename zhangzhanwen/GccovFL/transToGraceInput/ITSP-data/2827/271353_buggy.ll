; ModuleID = 'gcov/../WA_c/271353_buggy.c'
source_filename = "gcov/../WA_c/271353_buggy.c"
...
define i32 @main() #0 !dbg !253 {
  ...
  call void @llvm.dbg.declare(metadata float* %5, metadata !260, metadata !DIExpression()), !dbg !261
  call void @llvm.dbg.declare(metadata float* %6, metadata !262, metadata !DIExpression()), !dbg !263
  call void @llvm.dbg.declare(metadata float* %7, metadata !264, metadata !DIExpression()), !dbg !265
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6, float* %7), !dbg !266
  %9 = load float, float* %7, align 4, !dbg !267
  %10 = load float, float* %5, align 4, !dbg !269
  %11 = fsub float %9, %10, !dbg !270
  %12 = load float, float* %6, align 4, !dbg !271
  %13 = load float, float* %4, align 4, !dbg !272
  %14 = fsub float %12, %13, !dbg !273
  %15 = fdiv float %11, %14, !dbg !274
  %16 = load float, float* %5, align 4, !dbg !275
  %17 = load float, float* %3, align 4, !dbg !276
  %18 = fsub float %16, %17, !dbg !277
  %19 = load float, float* %4, align 4, !dbg !278
  %20 = load float, float* %2, align 4, !dbg !279
  %21 = fsub float %19, %20, !dbg !280
  %22 = fdiv float %18, %21, !dbg !281
  %23 = fcmp oeq float %15, %22, !dbg !282
  br i1 %23, label %24, label %26, !dbg !283

; <label>:24:                                     ; preds = %0
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1, i32 0, i32 0)), !dbg !284
  br label %28, !dbg !286

; <label>:26:                                     ; preds = %0
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i32 0, i32 0)), !dbg !287
  br label %28
...
!1 = !DIFile(filename: "gcov/../WA_c/271353_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
!2 = !{}
...
!15 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cstdlib", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!58 = !DIFile(filename: "/usr/include/clang/6.0.0/include/stddef.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!213 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!254 = !DILocalVariable(name: "x1", scope: !253, file: !1, line: 6, type: !195)
!255 = !DILocation(line: 6, column: 11, scope: !253)
!256 = !DILocalVariable(name: "y1", scope: !253, file: !1, line: 6, type: !195)
!257 = !DILocation(line: 6, column: 14, scope: !253)
!258 = !DILocalVariable(name: "x2", scope: !253, file: !1, line: 6, type: !195)
!259 = !DILocation(line: 6, column: 17, scope: !253)
!260 = !DILocalVariable(name: "y2", scope: !253, file: !1, line: 6, type: !195)
!261 = !DILocation(line: 6, column: 20, scope: !253)
!262 = !DILocalVariable(name: "x3", scope: !253, file: !1, line: 6, type: !195)
!263 = !DILocation(line: 6, column: 23, scope: !253)
!264 = !DILocalVariable(name: "y3", scope: !253, file: !1, line: 6, type: !195)
!265 = !DILocation(line: 6, column: 26, scope: !253)
!266 = !DILocation(line: 7, column: 5, scope: !253)
!267 = !DILocation(line: 8, column: 10, scope: !268)
!268 = distinct !DILexicalBlock(scope: !253, file: !1, line: 8, column: 9)
!269 = !DILocation(line: 8, column: 13, scope: !268)
!270 = !DILocation(line: 8, column: 12, scope: !268)
!271 = !DILocation(line: 8, column: 18, scope: !268)
!272 = !DILocation(line: 8, column: 21, scope: !268)
!273 = !DILocation(line: 8, column: 20, scope: !268)
!274 = !DILocation(line: 8, column: 16, scope: !268)
!275 = !DILocation(line: 8, column: 27, scope: !268)
!276 = !DILocation(line: 8, column: 30, scope: !268)
!277 = !DILocation(line: 8, column: 29, scope: !268)
!278 = !DILocation(line: 8, column: 35, scope: !268)
!279 = !DILocation(line: 8, column: 38, scope: !268)
!280 = !DILocation(line: 8, column: 37, scope: !268)
!281 = !DILocation(line: 8, column: 33, scope: !268)
!282 = !DILocation(line: 8, column: 24, scope: !268)
!283 = !DILocation(line: 8, column: 9, scope: !253)
!284 = !DILocation(line: 10, column: 9, scope: !285)
!285 = distinct !DILexicalBlock(scope: !268, file: !1, line: 9, column: 5)
!286 = !DILocation(line: 11, column: 5, scope: !285)
!287 = !DILocation(line: 14, column: 9, scope: !288)
!288 = distinct !DILexicalBlock(scope: !268, file: !1, line: 13, column: 5)
!289 = !DILocation(line: 16, column: 5, scope: !253)
