; ModuleID = 'gcov/../WA_c/271299_buggy.c'
source_filename = "gcov/../WA_c/271299_buggy.c"
...
@.str.2 = private unnamed_addr constant [33 x i8] c"All points are not on same line.\00", align 1
...
define i32 @main() #0 !dbg !366 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6, float* %7), !dbg !381
  call void @llvm.dbg.declare(metadata float* %8, metadata !382, metadata !DIExpression()), !dbg !383
  %12 = load float, float* %2, align 4, !dbg !384
  %13 = load float, float* %4, align 4, !dbg !385
  %14 = fsub float %12, %13, !dbg !386
  %15 = load float, float* %2, align 4, !dbg !387
  %16 = load float, float* %4, align 4, !dbg !388
  %17 = fsub float %15, %16, !dbg !389
  %18 = fmul float %14, %17, !dbg !390
  %19 = load float, float* %3, align 4, !dbg !391
  %20 = load float, float* %5, align 4, !dbg !392
  %21 = fsub float %19, %20, !dbg !393
  %22 = load float, float* %3, align 4, !dbg !394
  %23 = load float, float* %5, align 4, !dbg !395
  %24 = fsub float %22, %23, !dbg !396
  %25 = fmul float %21, %24, !dbg !397
  %26 = fadd float %18, %25, !dbg !398
  %27 = call float @sqrtf(float %26) #4, !dbg !399
  store float %27, float* %8, align 4, !dbg !383
  call void @llvm.dbg.declare(metadata float* %9, metadata !400, metadata !DIExpression()), !dbg !401
  %28 = load float, float* %4, align 4, !dbg !402
  %29 = load float, float* %6, align 4, !dbg !403
  %30 = fsub float %28, %29, !dbg !404
  %31 = load float, float* %4, align 4, !dbg !405
  %32 = load float, float* %6, align 4, !dbg !406
  %33 = fsub float %31, %32, !dbg !407
  %34 = fmul float %30, %33, !dbg !408
  %35 = load float, float* %5, align 4, !dbg !409
  %36 = load float, float* %7, align 4, !dbg !410
  %37 = fsub float %35, %36, !dbg !411
  %38 = load float, float* %5, align 4, !dbg !412
  %39 = load float, float* %7, align 4, !dbg !413
  %40 = fsub float %38, %39, !dbg !414
  %41 = fmul float %37, %40, !dbg !415
  %42 = fadd float %34, %41, !dbg !416
  %43 = call float @sqrtf(float %42) #4, !dbg !417
  store float %43, float* %9, align 4, !dbg !401
  call void @llvm.dbg.declare(metadata float* %10, metadata !418, metadata !DIExpression()), !dbg !419
  %44 = load float, float* %6, align 4, !dbg !420
  %45 = load float, float* %2, align 4, !dbg !421
  %46 = fsub float %44, %45, !dbg !422
  %47 = load float, float* %6, align 4, !dbg !423
  %48 = load float, float* %2, align 4, !dbg !424
  %49 = fsub float %47, %48, !dbg !425
  %50 = fmul float %46, %49, !dbg !426
  %51 = load float, float* %7, align 4, !dbg !427
  %52 = load float, float* %3, align 4, !dbg !428
  %53 = fsub float %51, %52, !dbg !429
  %54 = load float, float* %7, align 4, !dbg !430
  %55 = load float, float* %3, align 4, !dbg !431
  %56 = fsub float %54, %55, !dbg !432
  %57 = fmul float %53, %56, !dbg !433
  %58 = fadd float %50, %57, !dbg !434
  %59 = call float @sqrtf(float %58) #4, !dbg !435
  store float %59, float* %10, align 4, !dbg !419
  %60 = load float, float* %8, align 4, !dbg !436
  %61 = load float, float* %9, align 4, !dbg !438
  %62 = fadd float %60, %61, !dbg !439
  %63 = load float, float* %10, align 4, !dbg !440
  %64 = fcmp oeq float %62, %63, !dbg !441
  br i1 %64, label %65, label %67, !dbg !442

; <label>:65:                                     ; preds = %0
  %66 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.1, i32 0, i32 0)), !dbg !443
  br label %69, !dbg !445

; <label>:67:                                     ; preds = %0
  %68 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i32 0, i32 0)), !dbg !446
  br label %69
...
!1 = !DIFile(filename: "gcov/../WA_c/271299_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
!2 = !{}
...
!7 = !DIFile(filename: "/usr/include/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !10}
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/bits/std_abs.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
...
!368 = !{!10}
!369 = !DILocalVariable(name: "x1", scope: !366, file: !1, line: 6, type: !76)
!370 = !DILocation(line: 6, column: 11, scope: !366)
!371 = !DILocalVariable(name: "y1", scope: !366, file: !1, line: 6, type: !76)
!372 = !DILocation(line: 6, column: 14, scope: !366)
!373 = !DILocalVariable(name: "x2", scope: !366, file: !1, line: 6, type: !76)
!374 = !DILocation(line: 6, column: 17, scope: !366)
!375 = !DILocalVariable(name: "y2", scope: !366, file: !1, line: 6, type: !76)
!376 = !DILocation(line: 6, column: 20, scope: !366)
!377 = !DILocalVariable(name: "x3", scope: !366, file: !1, line: 6, type: !76)
!378 = !DILocation(line: 6, column: 23, scope: !366)
!379 = !DILocalVariable(name: "y3", scope: !366, file: !1, line: 6, type: !76)
!380 = !DILocation(line: 6, column: 26, scope: !366)
!381 = !DILocation(line: 8, column: 5, scope: !366)
!382 = !DILocalVariable(name: "distance_1", scope: !366, file: !1, line: 13, type: !76)
!383 = !DILocation(line: 13, column: 11, scope: !366)
!384 = !DILocation(line: 13, column: 30, scope: !366)
!385 = !DILocation(line: 13, column: 33, scope: !366)
!386 = !DILocation(line: 13, column: 32, scope: !366)
!387 = !DILocation(line: 13, column: 38, scope: !366)
!388 = !DILocation(line: 13, column: 41, scope: !366)
!389 = !DILocation(line: 13, column: 40, scope: !366)
!390 = !DILocation(line: 13, column: 36, scope: !366)
!391 = !DILocation(line: 13, column: 48, scope: !366)
!392 = !DILocation(line: 13, column: 51, scope: !366)
!393 = !DILocation(line: 13, column: 50, scope: !366)
!394 = !DILocation(line: 13, column: 56, scope: !366)
!395 = !DILocation(line: 13, column: 59, scope: !366)
!396 = !DILocation(line: 13, column: 58, scope: !366)
!397 = !DILocation(line: 13, column: 54, scope: !366)
!398 = !DILocation(line: 13, column: 45, scope: !366)
!399 = !DILocation(line: 13, column: 22, scope: !366)
!400 = !DILocalVariable(name: "distance_2", scope: !366, file: !1, line: 15, type: !76)
!401 = !DILocation(line: 15, column: 11, scope: !366)
!402 = !DILocation(line: 15, column: 30, scope: !366)
!403 = !DILocation(line: 15, column: 33, scope: !366)
!404 = !DILocation(line: 15, column: 32, scope: !366)
!405 = !DILocation(line: 15, column: 38, scope: !366)
!406 = !DILocation(line: 15, column: 41, scope: !366)
!407 = !DILocation(line: 15, column: 40, scope: !366)
!408 = !DILocation(line: 15, column: 36, scope: !366)
!409 = !DILocation(line: 15, column: 48, scope: !366)
!410 = !DILocation(line: 15, column: 51, scope: !366)
!411 = !DILocation(line: 15, column: 50, scope: !366)
!412 = !DILocation(line: 15, column: 56, scope: !366)
!413 = !DILocation(line: 15, column: 59, scope: !366)
!414 = !DILocation(line: 15, column: 58, scope: !366)
!415 = !DILocation(line: 15, column: 54, scope: !366)
!416 = !DILocation(line: 15, column: 45, scope: !366)
!417 = !DILocation(line: 15, column: 22, scope: !366)
!418 = !DILocalVariable(name: "distance_3", scope: !366, file: !1, line: 17, type: !76)
!419 = !DILocation(line: 17, column: 11, scope: !366)
!420 = !DILocation(line: 17, column: 30, scope: !366)
!421 = !DILocation(line: 17, column: 33, scope: !366)
!422 = !DILocation(line: 17, column: 32, scope: !366)
!423 = !DILocation(line: 17, column: 38, scope: !366)
!424 = !DILocation(line: 17, column: 41, scope: !366)
!425 = !DILocation(line: 17, column: 40, scope: !366)
!426 = !DILocation(line: 17, column: 36, scope: !366)
!427 = !DILocation(line: 17, column: 48, scope: !366)
!428 = !DILocation(line: 17, column: 51, scope: !366)
!429 = !DILocation(line: 17, column: 50, scope: !366)
!430 = !DILocation(line: 17, column: 56, scope: !366)
!431 = !DILocation(line: 17, column: 59, scope: !366)
!432 = !DILocation(line: 17, column: 58, scope: !366)
!433 = !DILocation(line: 17, column: 54, scope: !366)
!434 = !DILocation(line: 17, column: 45, scope: !366)
!435 = !DILocation(line: 17, column: 22, scope: !366)
!436 = !DILocation(line: 23, column: 9, scope: !437)
!437 = distinct !DILexicalBlock(scope: !366, file: !1, line: 23, column: 9)
!438 = !DILocation(line: 23, column: 20, scope: !437)
!439 = !DILocation(line: 23, column: 19, scope: !437)
!440 = !DILocation(line: 23, column: 32, scope: !437)
!441 = !DILocation(line: 23, column: 30, scope: !437)
!442 = !DILocation(line: 23, column: 9, scope: !366)
!443 = !DILocation(line: 26, column: 9, scope: !444)
!444 = distinct !DILexicalBlock(scope: !437, file: !1, line: 24, column: 5)
!445 = !DILocation(line: 27, column: 5, scope: !444)
!446 = !DILocation(line: 30, column: 9, scope: !447)
!447 = distinct !DILexicalBlock(scope: !437, file: !1, line: 29, column: 5)
!448 = !DILocation(line: 33, column: 5, scope: !366)
