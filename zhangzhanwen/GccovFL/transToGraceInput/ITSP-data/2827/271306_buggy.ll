; ModuleID = 'gcov/../WA_c/271306_buggy.c'
source_filename = "gcov/../WA_c/271306_buggy.c"
...
; <label>:26:                                     ; preds = %0
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i32 0, i32 0)), !dbg !45
  br label %28
...
!1 = !DIFile(filename: "gcov/../WA_c/271306_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2827")
!2 = !{}
...
!34 = !DILocation(line: 7, column: 32, scope: !26)
!35 = !DILocation(line: 7, column: 31, scope: !26)
!36 = !DILocation(line: 7, column: 37, scope: !26)
!37 = !DILocation(line: 7, column: 40, scope: !26)
!38 = !DILocation(line: 7, column: 39, scope: !26)
!39 = !DILocation(line: 7, column: 35, scope: !26)
!40 = !DILocation(line: 7, column: 25, scope: !26)
