; ModuleID = 'gcov/../WA_c/270285_buggy.c'
source_filename = "gcov/../WA_c/270285_buggy.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"%f\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"input is zero.\00", align 1
@.str.2 = private unnamed_addr constant [18 x i8] c"%.4f is positive.\00", align 1
...
; <label>:8:                                      ; preds = %0
  ...
  %10 = fcmp ogt float %9, 0.000000e+00, !dbg !25
  br i1 %10, label %11, label %15, !dbg !26

; <label>:11:                                     ; preds = %8
  %12 = load float, float* %2, align 4, !dbg !27
  %13 = fpext float %12 to double, !dbg !27
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i32 0, i32 0), double %13), !dbg !29
  br label %19, !dbg !30

; <label>:15:                                     ; preds = %8
  %16 = load float, float* %2, align 4, !dbg !31
  %17 = fpext float %16 to double, !dbg !31
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0), double %17), !dbg !33
  br label %19
...
!1 = !DIFile(filename: "gcov/../WA_c/270285_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!23 = distinct !DILexicalBlock(scope: !24, file: !1, line: 14, column: 13)
!24 = distinct !DILexicalBlock(scope: !16, file: !1, line: 13, column: 5)
!25 = !DILocation(line: 14, column: 14, scope: !23)
!26 = !DILocation(line: 14, column: 13, scope: !24)
!27 = !DILocation(line: 16, column: 40, scope: !28)
!28 = distinct !DILexicalBlock(scope: !23, file: !1, line: 15, column: 9)
!29 = !DILocation(line: 16, column: 13, scope: !28)
!30 = !DILocation(line: 17, column: 9, scope: !28)
!31 = !DILocation(line: 20, column: 40, scope: !32)
!32 = distinct !DILexicalBlock(scope: !23, file: !1, line: 19, column: 9)
!33 = !DILocation(line: 20, column: 13, scope: !32)
!34 = !DILocation(line: 24, column: 5, scope: !7)
