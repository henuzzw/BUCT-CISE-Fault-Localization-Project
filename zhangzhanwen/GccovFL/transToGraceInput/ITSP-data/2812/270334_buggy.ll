; ModuleID = 'gcov/../WA_c/270334_buggy.c'
source_filename = "gcov/../WA_c/270334_buggy.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"%f\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"%f is negative\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"%f is positive\00", align 1
@.str.3 = private unnamed_addr constant [11 x i8] c"%f is zero\00", align 1
...
define i32 @main() #0 !dbg !366 {
  ...
  store float 0.000000e+00, float* %3, align 4, !dbg !372
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), float* %2), !dbg !373
  %5 = load float, float* %2, align 4, !dbg !374
  %6 = load float, float* %3, align 4, !dbg !376
  %7 = fcmp olt float %5, %6, !dbg !377
  br i1 %7, label %8, label %12, !dbg !378

; <label>:8:                                      ; preds = %0
  %9 = load float, float* %2, align 4, !dbg !379
  %10 = fpext float %9 to double, !dbg !379
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), double %10), !dbg !381
  br label %12, !dbg !382

; <label>:12:                                     ; preds = %8, %0
  %13 = load float, float* %2, align 4, !dbg !383
  %14 = load float, float* %3, align 4, !dbg !385
  %15 = fcmp ogt float %13, %14, !dbg !386
  br i1 %15, label %16, label %20, !dbg !387

; <label>:16:                                     ; preds = %12
  %17 = load float, float* %2, align 4, !dbg !388
  %18 = fpext float %17 to double, !dbg !388
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0), double %18), !dbg !390
  br label %20, !dbg !391

; <label>:20:                                     ; preds = %16, %12
  %21 = load float, float* %2, align 4, !dbg !392
  %22 = load float, float* %3, align 4, !dbg !394
  %23 = fcmp oeq float %21, %22, !dbg !395
  br i1 %23, label %24, label %28, !dbg !396

; <label>:24:                                     ; preds = %20
  %25 = load float, float* %2, align 4, !dbg !397
  %26 = fpext float %25 to double, !dbg !397
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), double %26), !dbg !399
  br label %28, !dbg !400
...
!1 = !DIFile(filename: "gcov/../WA_c/270334_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!7 = !DIFile(filename: "/usr/include/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !10}
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/bits/std_abs.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
...
!368 = !{!10}
!369 = !DILocalVariable(name: "a", scope: !366, file: !1, line: 6, type: !76)
!370 = !DILocation(line: 6, column: 11, scope: !366)
!371 = !DILocalVariable(name: "b", scope: !366, file: !1, line: 7, type: !76)
!372 = !DILocation(line: 7, column: 11, scope: !366)
!373 = !DILocation(line: 8, column: 5, scope: !366)
!374 = !DILocation(line: 9, column: 9, scope: !375)
!375 = distinct !DILexicalBlock(scope: !366, file: !1, line: 9, column: 9)
!376 = !DILocation(line: 9, column: 11, scope: !375)
!377 = !DILocation(line: 9, column: 10, scope: !375)
!378 = !DILocation(line: 9, column: 9, scope: !366)
!379 = !DILocation(line: 11, column: 33, scope: !380)
!380 = distinct !DILexicalBlock(scope: !375, file: !1, line: 10, column: 5)
!381 = !DILocation(line: 11, column: 9, scope: !380)
!382 = !DILocation(line: 12, column: 5, scope: !380)
!383 = !DILocation(line: 13, column: 9, scope: !384)
!384 = distinct !DILexicalBlock(scope: !366, file: !1, line: 13, column: 9)
!385 = !DILocation(line: 13, column: 11, scope: !384)
!386 = !DILocation(line: 13, column: 10, scope: !384)
!387 = !DILocation(line: 13, column: 9, scope: !366)
!388 = !DILocation(line: 15, column: 33, scope: !389)
!389 = distinct !DILexicalBlock(scope: !384, file: !1, line: 14, column: 5)
!390 = !DILocation(line: 15, column: 9, scope: !389)
!391 = !DILocation(line: 16, column: 5, scope: !389)
!392 = !DILocation(line: 17, column: 9, scope: !393)
!393 = distinct !DILexicalBlock(scope: !366, file: !1, line: 17, column: 9)
!394 = !DILocation(line: 17, column: 12, scope: !393)
!395 = !DILocation(line: 17, column: 10, scope: !393)
!396 = !DILocation(line: 17, column: 9, scope: !366)
!397 = !DILocation(line: 19, column: 29, scope: !398)
!398 = distinct !DILexicalBlock(scope: !393, file: !1, line: 18, column: 5)
!399 = !DILocation(line: 19, column: 9, scope: !398)
!400 = !DILocation(line: 20, column: 5, scope: !398)
!401 = !DILocation(line: 22, column: 5, scope: !366)
