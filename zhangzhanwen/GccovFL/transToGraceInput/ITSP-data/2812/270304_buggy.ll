; ModuleID = 'gcov/../WA_c/270304_buggy.c'
source_filename = "gcov/../WA_c/270304_buggy.c"
...
; <label>:10:                                     ; preds = %0
  ...
  %12 = fcmp olt float %11, 0.000000e+00, !dbg !25
  br i1 %12, label %13, label %17, !dbg !26

; <label>:13:                                     ; preds = %10
  %14 = load float, float* %2, align 4, !dbg !27
  %15 = fpext float %14 to double, !dbg !27
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i32 0, i32 0), double %15), !dbg !29
  br label %21, !dbg !30

; <label>:17:                                     ; preds = %10
  %18 = load float, float* %2, align 4, !dbg !31
  %19 = fpext float %18 to double, !dbg !31
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), double %19), !dbg !33
  br label %21
...
!1 = !DIFile(filename: "gcov/../WA_c/270304_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!15 = !DILocation(line: 8, column: 9, scope: !16)
!16 = distinct !DILexicalBlock(scope: !7, file: !1, line: 8, column: 9)
!17 = !DILocation(line: 8, column: 10, scope: !16)
!18 = !DILocation(line: 8, column: 9, scope: !7)
!19 = !DILocation(line: 10, column: 36, scope: !20)
...
!24 = distinct !DILexicalBlock(scope: !16, file: !1, line: 12, column: 13)
!25 = !DILocation(line: 12, column: 14, scope: !24)
!26 = !DILocation(line: 12, column: 13, scope: !16)
!27 = !DILocation(line: 14, column: 36, scope: !28)
!28 = distinct !DILexicalBlock(scope: !24, file: !1, line: 13, column: 5)
!29 = !DILocation(line: 14, column: 9, scope: !28)
!30 = !DILocation(line: 15, column: 5, scope: !28)
!31 = !DILocation(line: 18, column: 33, scope: !32)
!32 = distinct !DILexicalBlock(scope: !24, file: !1, line: 17, column: 5)
!33 = !DILocation(line: 18, column: 9, scope: !32)
