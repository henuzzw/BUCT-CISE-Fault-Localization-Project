; ModuleID = 'gcov/../WA_c/270277_buggy.c'
source_filename = "gcov/../WA_c/270277_buggy.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"%f\00", align 1
@.str.1 = private unnamed_addr constant [17 x i8] c"%.4f is positive\00", align 1
@.str.2 = private unnamed_addr constant [17 x i8] c"%f input is zero\00", align 1
...
; <label>:17:                                     ; preds = %13, %10
  ...
  %19 = fcmp olt float %18, 0.000000e+00, !dbg !33
  br i1 %19, label %20, label %24, !dbg !34

; <label>:20:                                     ; preds = %17
  %21 = load float, float* %2, align 4, !dbg !35
  %22 = fpext float %21 to double, !dbg !35
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i32 0, i32 0), double %22), !dbg !37
  br label %24, !dbg !38
...
!1 = !DIFile(filename: "gcov/../WA_c/270277_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
