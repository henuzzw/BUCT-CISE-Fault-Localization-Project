; ModuleID = 'gcov/../WA_c/270296_buggy.c'
source_filename = "gcov/../WA_c/270296_buggy.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [3 x i8] c"%f\00", align 1
@.str.1 = private unnamed_addr constant [20 x i8] c"%.4f is positive %d\00", align 1
@.str.2 = private unnamed_addr constant [18 x i8] c"%0.4f is negative\00", align 1
...
; <label>:6:                                      ; preds = %0
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), double %8), !dbg !21
  br label %20, !dbg !22
...
; <label>:17:                                     ; preds = %10
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0)), !dbg !31
  br label %19
...
!1 = !DIFile(filename: "gcov/../WA_c/270296_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!19 = !DILocation(line: 9, column: 38, scope: !20)
...
!27 = !DILocation(line: 13, column: 37, scope: !28)
...
!32 = distinct !DILexicalBlock(scope: !24, file: !1, line: 16, column: 5)
