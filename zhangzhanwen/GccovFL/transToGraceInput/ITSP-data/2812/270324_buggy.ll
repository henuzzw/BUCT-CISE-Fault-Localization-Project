; ModuleID = 'gcov/../WA_c/270324_buggy.c'
source_filename = "gcov/../WA_c/270324_buggy.c"
...
; <label>:17:                                     ; preds = %10
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0)), !dbg !31
  br label %19
...
!1 = !DIFile(filename: "gcov/../WA_c/270324_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!27 = !DILocation(line: 13, column: 36, scope: !28)
