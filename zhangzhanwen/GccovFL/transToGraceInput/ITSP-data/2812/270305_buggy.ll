; ModuleID = 'gcov/../WA_c/270305_buggy.c'
source_filename = "gcov/../WA_c/270305_buggy.c"
...
; <label>:8:                                      ; preds = %0
  ...
  %10 = fcmp ogt float %9, 0.000000e+00, !dbg !24
...
; <label>:15:                                     ; preds = %8
  ...
  %17 = fcmp olt float %16, 0.000000e+00, !dbg !32
  br i1 %17, label %18, label %22, !dbg !33

; <label>:18:                                     ; preds = %15
  %19 = load float, float* %2, align 4, !dbg !34
  %20 = fpext float %19 to double, !dbg !34
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i32 0, i32 0), double %20), !dbg !36
  br label %22, !dbg !37
...
!1 = !DIFile(filename: "gcov/../WA_c/270305_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!17 = !DILocation(line: 7, column: 13, scope: !16)
...
!23 = distinct !DILexicalBlock(scope: !16, file: !1, line: 11, column: 13)
!24 = !DILocation(line: 11, column: 19, scope: !23)
!25 = !DILocation(line: 11, column: 13, scope: !16)
!26 = !DILocation(line: 13, column: 36, scope: !27)
!27 = distinct !DILexicalBlock(scope: !23, file: !1, line: 12, column: 5)
!28 = !DILocation(line: 13, column: 9, scope: !27)
!29 = !DILocation(line: 14, column: 5, scope: !27)
!30 = !DILocation(line: 15, column: 13, scope: !31)
!31 = distinct !DILexicalBlock(scope: !23, file: !1, line: 15, column: 13)
!32 = !DILocation(line: 15, column: 19, scope: !31)
!33 = !DILocation(line: 15, column: 13, scope: !23)
!34 = !DILocation(line: 17, column: 35, scope: !35)
!35 = distinct !DILexicalBlock(scope: !31, file: !1, line: 16, column: 5)
!36 = !DILocation(line: 17, column: 9, scope: !35)
