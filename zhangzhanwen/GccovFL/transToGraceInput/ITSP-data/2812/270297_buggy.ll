; ModuleID = 'gcov/../WA_c/270297_buggy.c'
source_filename = "gcov/../WA_c/270297_buggy.c"
...
; <label>:13:                                     ; preds = %10
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0), double %15), !dbg !29
  br label %23, !dbg !30

; <label>:17:                                     ; preds = %10
  %18 = load float, float* %2, align 4, !dbg !31
  %19 = fcmp oeq float %18, 4.800000e+01, !dbg !33
  br i1 %19, label %20, label %22, !dbg !34

; <label>:20:                                     ; preds = %17
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0)), !dbg !35
  br label %22, !dbg !37
...
!1 = !DIFile(filename: "gcov/../WA_c/270297_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2812")
!2 = !{}
...
!27 = !DILocation(line: 13, column: 35, scope: !28)
...
!31 = !DILocation(line: 15, column: 13, scope: !32)
!32 = distinct !DILexicalBlock(scope: !24, file: !1, line: 15, column: 13)
!33 = !DILocation(line: 15, column: 14, scope: !32)
!34 = !DILocation(line: 15, column: 13, scope: !24)
