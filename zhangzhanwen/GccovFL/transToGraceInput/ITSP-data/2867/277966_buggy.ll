; ModuleID = 'gcov/../WA_c/277966_buggy.c'
source_filename = "gcov/../WA_c/277966_buggy.c"
...
; <label>:17:                                     ; preds = %16
  ...
  %19 = add nsw i32 %18, 1, !dbg !37
  store i32 %19, i32* %4, align 4, !dbg !37
  br label %12, !dbg !38, !llvm.loop !39

; <label>:20:                                     ; preds = %12
  %21 = load i32, i32* %5, align 4, !dbg !41
  %22 = load i32, i32* %4, align 4, !dbg !42
  %23 = add nsw i32 %21, %22, !dbg !43
  store i32 %23, i32* %5, align 4, !dbg !44
  br label %24, !dbg !45

; <label>:24:                                     ; preds = %20
  %25 = load i32, i32* %2, align 4, !dbg !46
  %26 = add nsw i32 %25, 1, !dbg !46
  store i32 %26, i32* %2, align 4, !dbg !46
  br label %7, !dbg !47, !llvm.loop !48

; <label>:27:                                     ; preds = %7
  %28 = load i32, i32* %5, align 4, !dbg !50
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32 %28), !dbg !51
  ret i32 0, !dbg !52
}
...
!1 = !DIFile(filename: "gcov/../WA_c/277966_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2867")
!2 = !{}
...
!34 = !DILocation(line: 9, column: 21, scope: !33)
!35 = !DILocation(line: 9, column: 19, scope: !33)
!36 = !DILocation(line: 9, column: 9, scope: !29)
!37 = !DILocation(line: 9, column: 25, scope: !33)
!38 = !DILocation(line: 9, column: 9, scope: !33)
!39 = distinct !{!39, !36, !40}
!40 = !DILocation(line: 9, column: 28, scope: !29)
!41 = !DILocation(line: 10, column: 15, scope: !30)
!42 = !DILocation(line: 10, column: 21, scope: !30)
!43 = !DILocation(line: 10, column: 19, scope: !30)
!44 = !DILocation(line: 10, column: 13, scope: !30)
!45 = !DILocation(line: 11, column: 5, scope: !30)
!46 = !DILocation(line: 7, column: 21, scope: !24)
!47 = !DILocation(line: 7, column: 5, scope: !24)
!48 = distinct !{!48, !27, !49}
!49 = !DILocation(line: 11, column: 5, scope: !21)
!50 = !DILocation(line: 12, column: 17, scope: !7)
!51 = !DILocation(line: 12, column: 5, scope: !7)
!52 = !DILocation(line: 14, column: 5, scope: !7)
