; ModuleID = 'gcov/../WA_c/271173_buggy.c'
source_filename = "gcov/../WA_c/271173_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6), !dbg !379
  call void @llvm.dbg.declare(metadata float* %7, metadata !380, metadata !DIExpression()), !dbg !381
  %9 = load float, float* %5, align 4, !dbg !382
  %10 = load float, float* %2, align 4, !dbg !383
  %11 = fsub float %9, %10, !dbg !384
  %12 = load float, float* %5, align 4, !dbg !385
  %13 = load float, float* %2, align 4, !dbg !386
  %14 = fsub float %12, %13, !dbg !387
  %15 = fmul float %11, %14, !dbg !388
  %16 = load float, float* %6, align 4, !dbg !389
  %17 = load float, float* %3, align 4, !dbg !390
  %18 = fsub float %16, %17, !dbg !391
  %19 = load float, float* %6, align 4, !dbg !392
  %20 = load float, float* %3, align 4, !dbg !393
  %21 = fsub float %19, %20, !dbg !394
  %22 = fmul float %18, %21, !dbg !395
  %23 = fadd float %15, %22, !dbg !396
  %24 = call float @sqrtf(float %23) #4, !dbg !397
  store float %24, float* %7, align 4, !dbg !381
  %25 = load float, float* %7, align 4, !dbg !398
  %26 = load float, float* %4, align 4, !dbg !400
  %27 = fcmp oeq float %25, %26, !dbg !401
  br i1 %27, label %32, label %28, !dbg !402

; <label>:28:                                     ; preds = %0
  %29 = load float, float* %7, align 4, !dbg !403
  %30 = load float, float* %4, align 4, !dbg !404
  %31 = fcmp olt float %29, %30, !dbg !405
  br i1 %31, label %32, label %41, !dbg !406

; <label>:32:                                     ; preds = %28, %0
  %33 = load float, float* %7, align 4, !dbg !407
  %34 = load float, float* %4, align 4, !dbg !410
  %35 = fcmp oeq float %33, %34, !dbg !411
  br i1 %35, label %36, label %38, !dbg !412

; <label>:36:                                     ; preds = %32
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0)), !dbg !413
  br label %40, !dbg !415

; <label>:38:                                     ; preds = %32
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0)), !dbg !416
  br label %40
...
; <label>:41:                                     ; preds = %28
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0)), !dbg !419
  br label %43
...
!1 = !DIFile(filename: "gcov/../WA_c/271173_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!380 = !DILocalVariable(name: "d", scope: !366, file: !1, line: 9, type: !76)
!381 = !DILocation(line: 9, column: 11, scope: !366)
!382 = !DILocation(line: 9, column: 20, scope: !366)
!383 = !DILocation(line: 9, column: 23, scope: !366)
!384 = !DILocation(line: 9, column: 22, scope: !366)
!385 = !DILocation(line: 9, column: 27, scope: !366)
!386 = !DILocation(line: 9, column: 30, scope: !366)
!387 = !DILocation(line: 9, column: 29, scope: !366)
!388 = !DILocation(line: 9, column: 25, scope: !366)
!389 = !DILocation(line: 9, column: 34, scope: !366)
!390 = !DILocation(line: 9, column: 37, scope: !366)
!391 = !DILocation(line: 9, column: 36, scope: !366)
!392 = !DILocation(line: 9, column: 41, scope: !366)
!393 = !DILocation(line: 9, column: 44, scope: !366)
!394 = !DILocation(line: 9, column: 43, scope: !366)
!395 = !DILocation(line: 9, column: 39, scope: !366)
!396 = !DILocation(line: 9, column: 32, scope: !366)
!397 = !DILocation(line: 9, column: 13, scope: !366)
!398 = !DILocation(line: 12, column: 10, scope: !399)
!399 = distinct !DILexicalBlock(scope: !366, file: !1, line: 12, column: 9)
!400 = !DILocation(line: 12, column: 13, scope: !399)
!401 = !DILocation(line: 12, column: 11, scope: !399)
!402 = !DILocation(line: 12, column: 15, scope: !399)
!403 = !DILocation(line: 12, column: 18, scope: !399)
!404 = !DILocation(line: 12, column: 20, scope: !399)
!405 = !DILocation(line: 12, column: 19, scope: !399)
!406 = !DILocation(line: 12, column: 9, scope: !366)
!407 = !DILocation(line: 14, column: 13, scope: !408)
!408 = distinct !DILexicalBlock(scope: !409, file: !1, line: 14, column: 13)
!409 = distinct !DILexicalBlock(scope: !399, file: !1, line: 13, column: 5)
!410 = !DILocation(line: 14, column: 16, scope: !408)
!411 = !DILocation(line: 14, column: 14, scope: !408)
!412 = !DILocation(line: 14, column: 13, scope: !409)
!413 = !DILocation(line: 16, column: 13, scope: !414)
!414 = distinct !DILexicalBlock(scope: !408, file: !1, line: 15, column: 9)
!415 = !DILocation(line: 17, column: 9, scope: !414)
!416 = !DILocation(line: 20, column: 13, scope: !417)
!417 = distinct !DILexicalBlock(scope: !408, file: !1, line: 19, column: 9)
!418 = !DILocation(line: 22, column: 5, scope: !409)
!419 = !DILocation(line: 25, column: 9, scope: !420)
!420 = distinct !DILexicalBlock(scope: !399, file: !1, line: 24, column: 5)
!421 = !DILocation(line: 28, column: 5, scope: !366)
