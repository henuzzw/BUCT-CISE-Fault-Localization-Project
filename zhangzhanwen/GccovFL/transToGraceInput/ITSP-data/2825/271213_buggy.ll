; ModuleID = 'gcov/../WA_c/271213_buggy.c'
source_filename = "gcov/../WA_c/271213_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %5, float* %6, float* %4), !dbg !381
  %9 = load float, float* %2, align 4, !dbg !382
  %10 = load float, float* %5, align 4, !dbg !383
  %11 = fsub float %9, %10, !dbg !384
  %12 = load float, float* %2, align 4, !dbg !385
  %13 = load float, float* %5, align 4, !dbg !386
  %14 = fsub float %12, %13, !dbg !387
  %15 = fmul float %11, %14, !dbg !388
  %16 = load float, float* %3, align 4, !dbg !389
  %17 = load float, float* %6, align 4, !dbg !390
  %18 = fsub float %16, %17, !dbg !391
  %19 = load float, float* %3, align 4, !dbg !392
  %20 = load float, float* %6, align 4, !dbg !393
  ...
  store float %24, float* %7, align 4, !dbg !398
  %25 = load float, float* %4, align 4, !dbg !399
  %26 = load float, float* %7, align 4, !dbg !401
  %27 = fcmp ogt float %25, %26, !dbg !402
  br i1 %27, label %28, label %30, !dbg !403

; <label>:28:                                     ; preds = %0
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i32 0, i32 0)), !dbg !404
  br label %39, !dbg !406

; <label>:30:                                     ; preds = %0
  %31 = load float, float* %4, align 4, !dbg !407
  %32 = load float, float* %7, align 4, !dbg !409
  %33 = fcmp oeq float %31, %32, !dbg !410
  br i1 %33, label %34, label %36, !dbg !411

; <label>:34:                                     ; preds = %30
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0)), !dbg !412
  br label %38, !dbg !414

; <label>:36:                                     ; preds = %30
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i32 0, i32 0)), !dbg !415
  br label %38
...
define linkonce_odr float @_ZSt4sqrtf(float) #3 comdat !dbg !418 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  call void @llvm.dbg.declare(metadata float* %2, metadata !419, metadata !DIExpression()), !dbg !420
  %3 = load float, float* %2, align 4, !dbg !421
  %4 = call float @sqrtf(float %3) #5, !dbg !422
  ret float %4, !dbg !423
}
...
!1 = !DIFile(filename: "gcov/../WA_c/271213_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!379 = !DILocalVariable(name: "s", scope: !366, file: !1, line: 5, type: !76)
!380 = !DILocation(line: 5, column: 23, scope: !366)
!381 = !DILocation(line: 6, column: 5, scope: !366)
!382 = !DILocation(line: 7, column: 13, scope: !366)
!383 = !DILocation(line: 7, column: 15, scope: !366)
!384 = !DILocation(line: 7, column: 14, scope: !366)
!385 = !DILocation(line: 7, column: 20, scope: !366)
!386 = !DILocation(line: 7, column: 22, scope: !366)
!387 = !DILocation(line: 7, column: 21, scope: !366)
!388 = !DILocation(line: 7, column: 18, scope: !366)
!389 = !DILocation(line: 7, column: 27, scope: !366)
!390 = !DILocation(line: 7, column: 29, scope: !366)
!391 = !DILocation(line: 7, column: 28, scope: !366)
!392 = !DILocation(line: 7, column: 34, scope: !366)
!393 = !DILocation(line: 7, column: 36, scope: !366)
!394 = !DILocation(line: 7, column: 35, scope: !366)
!395 = !DILocation(line: 7, column: 32, scope: !366)
!396 = !DILocation(line: 7, column: 25, scope: !366)
!397 = !DILocation(line: 7, column: 7, scope: !366)
!398 = !DILocation(line: 7, column: 6, scope: !366)
!399 = !DILocation(line: 8, column: 10, scope: !400)
!400 = distinct !DILexicalBlock(scope: !366, file: !1, line: 8, column: 10)
!401 = !DILocation(line: 8, column: 13, scope: !400)
!402 = !DILocation(line: 8, column: 12, scope: !400)
!403 = !DILocation(line: 8, column: 10, scope: !366)
!404 = !DILocation(line: 10, column: 9, scope: !405)
!405 = distinct !DILexicalBlock(scope: !400, file: !1, line: 9, column: 5)
!406 = !DILocation(line: 12, column: 5, scope: !405)
!407 = !DILocation(line: 13, column: 13, scope: !408)
!408 = distinct !DILexicalBlock(scope: !400, file: !1, line: 13, column: 13)
!409 = !DILocation(line: 13, column: 18, scope: !408)
!410 = !DILocation(line: 13, column: 15, scope: !408)
!411 = !DILocation(line: 13, column: 13, scope: !400)
...
!415 = !DILocation(line: 19, column: 9, scope: !416)
!416 = distinct !DILexicalBlock(scope: !408, file: !1, line: 18, column: 5)
!417 = !DILocation(line: 21, column: 5, scope: !366)
!418 = distinct !DISubprogram(name: "sqrt", linkageName: "_ZSt4sqrtf", scope: !5, file: !18, line: 463, type: !81, isLocal: false, isDefinition: true, scopeLine: 464, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!419 = !DILocalVariable(name: "__x", arg: 1, scope: !418, file: !18, line: 463, type: !76)
!420 = !DILocation(line: 463, column: 14, scope: !418)
!421 = !DILocation(line: 464, column: 28, scope: !418)
!422 = !DILocation(line: 464, column: 12, scope: !418)
!423 = !DILocation(line: 464, column: 5, scope: !418)
