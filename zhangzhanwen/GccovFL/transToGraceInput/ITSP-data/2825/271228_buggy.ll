; ModuleID = 'gcov/../WA_c/271228_buggy.c'
source_filename = "gcov/../WA_c/271228_buggy.c"
...
define i32 @main() #0 !dbg !7 {
  ...
  %29 = fcmp ogt float %28, 0.000000e+00, !dbg !47
  br i1 %29, label %30, label %32, !dbg !48

; <label>:30:                                     ; preds = %0
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0)), !dbg !49
  br label %44, !dbg !51
...
; <label>:37:                                     ; preds = %32
  %38 = load float, float* %4, align 4, !dbg !59
  %39 = fcmp olt float %38, 0.000000e+00, !dbg !61
  br i1 %39, label %40, label %42, !dbg !62

; <label>:40:                                     ; preds = %37
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0)), !dbg !63
  br label %42, !dbg !65
...
!1 = !DIFile(filename: "gcov/../WA_c/271228_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!22 = !DILocalVariable(name: "k", scope: !7, file: !1, line: 5, type: !12)
...
!60 = distinct !DILexicalBlock(scope: !53, file: !1, line: 16, column: 13)
!61 = !DILocation(line: 16, column: 14, scope: !60)
!62 = !DILocation(line: 16, column: 13, scope: !53)
!63 = !DILocation(line: 18, column: 9, scope: !64)
!64 = distinct !DILexicalBlock(scope: !60, file: !1, line: 17, column: 5)
!65 = !DILocation(line: 19, column: 5, scope: !64)
!66 = !DILocation(line: 21, column: 5, scope: !7)
