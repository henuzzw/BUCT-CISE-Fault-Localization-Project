; ModuleID = 'gcov/../WA_c/271209_buggy.c'
source_filename = "gcov/../WA_c/271209_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6), !dbg !379
  call void @llvm.dbg.declare(metadata float* %7, metadata !380, metadata !DIExpression()), !dbg !381
  %10 = load float, float* %2, align 4, !dbg !382
  %11 = load float, float* %5, align 4, !dbg !383
  %12 = fsub float %10, %11, !dbg !384
  %13 = load float, float* %2, align 4, !dbg !385
  %14 = load float, float* %5, align 4, !dbg !386
  %15 = fsub float %13, %14, !dbg !387
  %16 = fmul float %12, %15, !dbg !388
  %17 = load float, float* %3, align 4, !dbg !389
  %18 = load float, float* %6, align 4, !dbg !390
  %19 = fsub float %17, %18, !dbg !391
  %20 = load float, float* %3, align 4, !dbg !392
  %21 = load float, float* %6, align 4, !dbg !393
  %22 = fsub float %20, %21, !dbg !394
  %23 = fmul float %19, %22, !dbg !395
  %24 = fadd float %16, %23, !dbg !396
  store float %24, float* %7, align 4, !dbg !381
  call void @llvm.dbg.declare(metadata float* %8, metadata !397, metadata !DIExpression()), !dbg !398
  %25 = load float, float* %7, align 4, !dbg !399
  %26 = call float @sqrtf(float %25) #4, !dbg !400
  store float %26, float* %8, align 4, !dbg !398
  %27 = load float, float* %8, align 4, !dbg !401
  %28 = load float, float* %4, align 4, !dbg !403
  %29 = fcmp oeq float %27, %28, !dbg !404
  br i1 %29, label %30, label %32, !dbg !405

; <label>:30:                                     ; preds = %0
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0)), !dbg !406
  br label %46, !dbg !408

; <label>:32:                                     ; preds = %0
  %33 = load float, float* %8, align 4, !dbg !409
  %34 = load float, float* %4, align 4, !dbg !411
  %35 = fcmp ogt float %33, %34, !dbg !412
  br i1 %35, label %36, label %38, !dbg !413

; <label>:36:                                     ; preds = %32
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0)), !dbg !414
  br label %45, !dbg !416

; <label>:38:                                     ; preds = %32
  %39 = load float, float* %8, align 4, !dbg !417
  %40 = load float, float* %4, align 4, !dbg !419
  %41 = fcmp olt float %39, %40, !dbg !420
  br i1 %41, label %42, label %44, !dbg !421

; <label>:42:                                     ; preds = %38
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0)), !dbg !422
  br label %44, !dbg !424
...
!1 = !DIFile(filename: "gcov/../WA_c/271209_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!380 = !DILocalVariable(name: "m", scope: !366, file: !1, line: 7, type: !76)
!381 = !DILocation(line: 7, column: 11, scope: !366)
!382 = !DILocation(line: 7, column: 14, scope: !366)
!383 = !DILocation(line: 7, column: 16, scope: !366)
!384 = !DILocation(line: 7, column: 15, scope: !366)
!385 = !DILocation(line: 7, column: 21, scope: !366)
!386 = !DILocation(line: 7, column: 23, scope: !366)
!387 = !DILocation(line: 7, column: 22, scope: !366)
!388 = !DILocation(line: 7, column: 19, scope: !366)
!389 = !DILocation(line: 7, column: 28, scope: !366)
!390 = !DILocation(line: 7, column: 30, scope: !366)
!391 = !DILocation(line: 7, column: 29, scope: !366)
!392 = !DILocation(line: 7, column: 35, scope: !366)
!393 = !DILocation(line: 7, column: 37, scope: !366)
!394 = !DILocation(line: 7, column: 36, scope: !366)
!395 = !DILocation(line: 7, column: 33, scope: !366)
!396 = !DILocation(line: 7, column: 26, scope: !366)
!397 = !DILocalVariable(name: "d", scope: !366, file: !1, line: 8, type: !76)
!398 = !DILocation(line: 8, column: 11, scope: !366)
!399 = !DILocation(line: 8, column: 19, scope: !366)
!400 = !DILocation(line: 8, column: 13, scope: !366)
!401 = !DILocation(line: 9, column: 8, scope: !402)
!402 = distinct !DILexicalBlock(scope: !366, file: !1, line: 9, column: 8)
!403 = !DILocation(line: 9, column: 11, scope: !402)
!404 = !DILocation(line: 9, column: 9, scope: !402)
!405 = !DILocation(line: 9, column: 8, scope: !366)
!406 = !DILocation(line: 11, column: 9, scope: !407)
!407 = distinct !DILexicalBlock(scope: !402, file: !1, line: 10, column: 5)
!408 = !DILocation(line: 12, column: 5, scope: !407)
!409 = !DILocation(line: 13, column: 13, scope: !410)
!410 = distinct !DILexicalBlock(scope: !402, file: !1, line: 13, column: 13)
!411 = !DILocation(line: 13, column: 15, scope: !410)
!412 = !DILocation(line: 13, column: 14, scope: !410)
!413 = !DILocation(line: 13, column: 13, scope: !402)
!414 = !DILocation(line: 15, column: 9, scope: !415)
!415 = distinct !DILexicalBlock(scope: !410, file: !1, line: 14, column: 5)
!416 = !DILocation(line: 16, column: 5, scope: !415)
!417 = !DILocation(line: 17, column: 13, scope: !418)
!418 = distinct !DILexicalBlock(scope: !410, file: !1, line: 17, column: 13)
!419 = !DILocation(line: 17, column: 15, scope: !418)
!420 = !DILocation(line: 17, column: 14, scope: !418)
!421 = !DILocation(line: 17, column: 13, scope: !410)
!422 = !DILocation(line: 19, column: 9, scope: !423)
!423 = distinct !DILexicalBlock(scope: !418, file: !1, line: 18, column: 5)
!424 = !DILocation(line: 20, column: 5, scope: !423)
!425 = !DILocation(line: 21, column: 5, scope: !366)
