; ModuleID = 'gcov/../WA_c/271220_buggy.c'
source_filename = "gcov/../WA_c/271220_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6), !dbg !379
  %8 = load float, float* %6, align 4, !dbg !380
  %9 = load float, float* %2, align 4, !dbg !382
  %10 = load float, float* %4, align 4, !dbg !383
  %11 = fsub float %9, %10, !dbg !384
  %12 = load float, float* %2, align 4, !dbg !385
  %13 = load float, float* %4, align 4, !dbg !386
  %14 = fsub float %12, %13, !dbg !387
  %15 = fmul float %11, %14, !dbg !388
  %16 = load float, float* %3, align 4, !dbg !389
  %17 = load float, float* %5, align 4, !dbg !390
  %18 = fsub float %16, %17, !dbg !391
  %19 = load float, float* %3, align 4, !dbg !392
  %20 = load float, float* %5, align 4, !dbg !393
  %21 = fsub float %19, %20, !dbg !394
  %22 = fmul float %18, %21, !dbg !395
  %23 = fadd float %15, %22, !dbg !396
  %24 = call float @_ZSt4sqrtf(float %23), !dbg !397
  %25 = fcmp oeq float %8, %24, !dbg !398
  br i1 %25, label %26, label %28, !dbg !399

; <label>:26:                                     ; preds = %0
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0)), !dbg !400
  br label %52, !dbg !402

; <label>:28:                                     ; preds = %0
  %29 = load float, float* %6, align 4, !dbg !403
  %30 = load float, float* %2, align 4, !dbg !406
  %31 = load float, float* %4, align 4, !dbg !407
  %32 = fsub float %30, %31, !dbg !408
  %33 = load float, float* %2, align 4, !dbg !409
  %34 = load float, float* %4, align 4, !dbg !410
  %35 = fsub float %33, %34, !dbg !411
  %36 = fmul float %32, %35, !dbg !412
  %37 = load float, float* %3, align 4, !dbg !413
  %38 = load float, float* %5, align 4, !dbg !414
  %39 = fsub float %37, %38, !dbg !415
  %40 = load float, float* %3, align 4, !dbg !416
  %41 = load float, float* %5, align 4, !dbg !417
  %42 = fsub float %40, %41, !dbg !418
  %43 = fmul float %39, %42, !dbg !419
  %44 = fadd float %36, %43, !dbg !420
  %45 = call float @_ZSt4sqrtf(float %44), !dbg !421
  %46 = fcmp olt float %29, %45, !dbg !422
  br i1 %46, label %47, label %49, !dbg !423

; <label>:47:                                     ; preds = %28
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0)), !dbg !424
  br label %51, !dbg !426

; <label>:49:                                     ; preds = %28
  %50 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0)), !dbg !427
  br label %51
...
define linkonce_odr float @_ZSt4sqrtf(float) #3 comdat !dbg !430 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  call void @llvm.dbg.declare(metadata float* %2, metadata !431, metadata !DIExpression()), !dbg !432
  %3 = load float, float* %2, align 4, !dbg !433
  %4 = call float @sqrtf(float %3) #5, !dbg !434
  ret float %4, !dbg !435
}
...
!1 = !DIFile(filename: "gcov/../WA_c/271220_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!368 = !{!10}
!369 = !DILocalVariable(name: "x", scope: !366, file: !1, line: 5, type: !76)
!370 = !DILocation(line: 5, column: 11, scope: !366)
!371 = !DILocalVariable(name: "y", scope: !366, file: !1, line: 5, type: !76)
!372 = !DILocation(line: 5, column: 13, scope: !366)
!373 = !DILocalVariable(name: "x1", scope: !366, file: !1, line: 5, type: !76)
!374 = !DILocation(line: 5, column: 15, scope: !366)
!375 = !DILocalVariable(name: "y1", scope: !366, file: !1, line: 5, type: !76)
!376 = !DILocation(line: 5, column: 18, scope: !366)
!377 = !DILocalVariable(name: "r", scope: !366, file: !1, line: 5, type: !76)
!378 = !DILocation(line: 5, column: 21, scope: !366)
!379 = !DILocation(line: 6, column: 5, scope: !366)
!380 = !DILocation(line: 7, column: 8, scope: !381)
!381 = distinct !DILexicalBlock(scope: !366, file: !1, line: 7, column: 8)
!382 = !DILocation(line: 7, column: 17, scope: !381)
!383 = !DILocation(line: 7, column: 19, scope: !381)
!384 = !DILocation(line: 7, column: 18, scope: !381)
!385 = !DILocation(line: 7, column: 24, scope: !381)
!386 = !DILocation(line: 7, column: 26, scope: !381)
!387 = !DILocation(line: 7, column: 25, scope: !381)
!388 = !DILocation(line: 7, column: 22, scope: !381)
!389 = !DILocation(line: 7, column: 31, scope: !381)
!390 = !DILocation(line: 7, column: 33, scope: !381)
!391 = !DILocation(line: 7, column: 32, scope: !381)
!392 = !DILocation(line: 7, column: 38, scope: !381)
!393 = !DILocation(line: 7, column: 40, scope: !381)
!394 = !DILocation(line: 7, column: 39, scope: !381)
!395 = !DILocation(line: 7, column: 36, scope: !381)
!396 = !DILocation(line: 7, column: 29, scope: !381)
!397 = !DILocation(line: 7, column: 11, scope: !381)
!398 = !DILocation(line: 7, column: 9, scope: !381)
!399 = !DILocation(line: 7, column: 8, scope: !366)
!400 = !DILocation(line: 9, column: 9, scope: !401)
!401 = distinct !DILexicalBlock(scope: !381, file: !1, line: 8, column: 5)
!402 = !DILocation(line: 10, column: 5, scope: !401)
!403 = !DILocation(line: 13, column: 12, scope: !404)
!404 = distinct !DILexicalBlock(scope: !405, file: !1, line: 13, column: 12)
!405 = distinct !DILexicalBlock(scope: !381, file: !1, line: 12, column: 5)
!406 = !DILocation(line: 13, column: 20, scope: !404)
!407 = !DILocation(line: 13, column: 22, scope: !404)
!408 = !DILocation(line: 13, column: 21, scope: !404)
!409 = !DILocation(line: 13, column: 27, scope: !404)
!410 = !DILocation(line: 13, column: 29, scope: !404)
!411 = !DILocation(line: 13, column: 28, scope: !404)
!412 = !DILocation(line: 13, column: 25, scope: !404)
!413 = !DILocation(line: 13, column: 34, scope: !404)
!414 = !DILocation(line: 13, column: 36, scope: !404)
!415 = !DILocation(line: 13, column: 35, scope: !404)
!416 = !DILocation(line: 13, column: 41, scope: !404)
!417 = !DILocation(line: 13, column: 43, scope: !404)
!418 = !DILocation(line: 13, column: 42, scope: !404)
!419 = !DILocation(line: 13, column: 39, scope: !404)
!420 = !DILocation(line: 13, column: 32, scope: !404)
!421 = !DILocation(line: 13, column: 14, scope: !404)
!422 = !DILocation(line: 13, column: 13, scope: !404)
!423 = !DILocation(line: 13, column: 12, scope: !405)
!424 = !DILocation(line: 15, column: 13, scope: !425)
!425 = distinct !DILexicalBlock(scope: !404, file: !1, line: 14, column: 9)
!426 = !DILocation(line: 16, column: 9, scope: !425)
!427 = !DILocation(line: 19, column: 13, scope: !428)
!428 = distinct !DILexicalBlock(scope: !404, file: !1, line: 18, column: 9)
!429 = !DILocation(line: 24, column: 5, scope: !366)
!430 = distinct !DISubprogram(name: "sqrt", linkageName: "_ZSt4sqrtf", scope: !5, file: !18, line: 463, type: !81, isLocal: false, isDefinition: true, scopeLine: 464, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!431 = !DILocalVariable(name: "__x", arg: 1, scope: !430, file: !18, line: 463, type: !76)
!432 = !DILocation(line: 463, column: 14, scope: !430)
!433 = !DILocation(line: 464, column: 28, scope: !430)
!434 = !DILocation(line: 464, column: 12, scope: !430)
!435 = !DILocation(line: 464, column: 5, scope: !430)
