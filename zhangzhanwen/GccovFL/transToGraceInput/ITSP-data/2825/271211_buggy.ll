; ModuleID = 'gcov/../WA_c/271211_buggy.c'
source_filename = "gcov/../WA_c/271211_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6), !dbg !379
  call void @llvm.dbg.declare(metadata float* %7, metadata !380, metadata !DIExpression()), !dbg !381
  %12 = load float, float* %5, align 4, !dbg !382
  %13 = load float, float* %2, align 4, !dbg !383
  %14 = fsub float %12, %13, !dbg !384
  %15 = load float, float* %5, align 4, !dbg !385
  %16 = load float, float* %2, align 4, !dbg !386
  %17 = fsub float %15, %16, !dbg !387
  %18 = fmul float %14, %17, !dbg !388
  store float %18, float* %7, align 4, !dbg !381
  call void @llvm.dbg.declare(metadata float* %8, metadata !389, metadata !DIExpression()), !dbg !390
  %19 = load float, float* %6, align 4, !dbg !391
  %20 = load float, float* %3, align 4, !dbg !392
  %21 = fsub float %19, %20, !dbg !393
  %22 = load float, float* %6, align 4, !dbg !394
  %23 = load float, float* %3, align 4, !dbg !395
  %24 = fsub float %22, %23, !dbg !396
  %25 = fmul float %21, %24, !dbg !397
  store float %25, float* %8, align 4, !dbg !390
  call void @llvm.dbg.declare(metadata float* %9, metadata !398, metadata !DIExpression()), !dbg !399
  %26 = load float, float* %7, align 4, !dbg !400
  %27 = load float, float* %8, align 4, !dbg !401
  %28 = fadd float %26, %27, !dbg !402
  store float %28, float* %9, align 4, !dbg !399
  call void @llvm.dbg.declare(metadata float* %10, metadata !403, metadata !DIExpression()), !dbg !404
  %29 = load float, float* %9, align 4, !dbg !405
  %30 = call float @sqrtf(float %29) #4, !dbg !406
  store float %30, float* %10, align 4, !dbg !404
  %31 = load float, float* %9, align 4, !dbg !407
  %32 = load float, float* %4, align 4, !dbg !409
  %33 = fcmp olt float %31, %32, !dbg !410
  br i1 %33, label %34, label %36, !dbg !411

; <label>:34:                                     ; preds = %0
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i32 0, i32 0)), !dbg !412
  br label %45, !dbg !414

; <label>:36:                                     ; preds = %0
  %37 = load float, float* %9, align 4, !dbg !415
  %38 = load float, float* %4, align 4, !dbg !417
  %39 = fcmp oeq float %37, %38, !dbg !418
  br i1 %39, label %40, label %42, !dbg !419

; <label>:40:                                     ; preds = %36
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0)), !dbg !420
  br label %44, !dbg !422

; <label>:42:                                     ; preds = %36
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i32 0, i32 0)), !dbg !423
  br label %44
...
!1 = !DIFile(filename: "gcov/../WA_c/271211_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!375 = !DILocalVariable(name: "x1", scope: !366, file: !1, line: 7, type: !76)
!376 = !DILocation(line: 7, column: 11, scope: !366)
!377 = !DILocalVariable(name: "y1", scope: !366, file: !1, line: 7, type: !76)
!378 = !DILocation(line: 7, column: 14, scope: !366)
!379 = !DILocation(line: 8, column: 5, scope: !366)
!380 = !DILocalVariable(name: "a", scope: !366, file: !1, line: 9, type: !76)
!381 = !DILocation(line: 9, column: 11, scope: !366)
!382 = !DILocation(line: 9, column: 14, scope: !366)
!383 = !DILocation(line: 9, column: 17, scope: !366)
!384 = !DILocation(line: 9, column: 16, scope: !366)
!385 = !DILocation(line: 9, column: 21, scope: !366)
!386 = !DILocation(line: 9, column: 24, scope: !366)
!387 = !DILocation(line: 9, column: 23, scope: !366)
!388 = !DILocation(line: 9, column: 19, scope: !366)
!389 = !DILocalVariable(name: "b", scope: !366, file: !1, line: 10, type: !76)
!390 = !DILocation(line: 10, column: 11, scope: !366)
!391 = !DILocation(line: 10, column: 14, scope: !366)
!392 = !DILocation(line: 10, column: 17, scope: !366)
!393 = !DILocation(line: 10, column: 16, scope: !366)
!394 = !DILocation(line: 10, column: 21, scope: !366)
!395 = !DILocation(line: 10, column: 24, scope: !366)
!396 = !DILocation(line: 10, column: 23, scope: !366)
!397 = !DILocation(line: 10, column: 19, scope: !366)
!398 = !DILocalVariable(name: "c", scope: !366, file: !1, line: 11, type: !76)
!399 = !DILocation(line: 11, column: 11, scope: !366)
!400 = !DILocation(line: 11, column: 13, scope: !366)
!401 = !DILocation(line: 11, column: 15, scope: !366)
!402 = !DILocation(line: 11, column: 14, scope: !366)
!403 = !DILocalVariable(name: "d", scope: !366, file: !1, line: 12, type: !76)
!404 = !DILocation(line: 12, column: 11, scope: !366)
!405 = !DILocation(line: 12, column: 19, scope: !366)
!406 = !DILocation(line: 12, column: 13, scope: !366)
!407 = !DILocation(line: 13, column: 8, scope: !408)
!408 = distinct !DILexicalBlock(scope: !366, file: !1, line: 13, column: 8)
!409 = !DILocation(line: 13, column: 10, scope: !408)
!410 = !DILocation(line: 13, column: 9, scope: !408)
!411 = !DILocation(line: 13, column: 8, scope: !366)
!412 = !DILocation(line: 15, column: 9, scope: !413)
!413 = distinct !DILexicalBlock(scope: !408, file: !1, line: 14, column: 5)
!414 = !DILocation(line: 16, column: 5, scope: !413)
!415 = !DILocation(line: 17, column: 13, scope: !416)
!416 = distinct !DILexicalBlock(scope: !408, file: !1, line: 17, column: 13)
!417 = !DILocation(line: 17, column: 16, scope: !416)
!418 = !DILocation(line: 17, column: 14, scope: !416)
!419 = !DILocation(line: 17, column: 13, scope: !408)
!420 = !DILocation(line: 19, column: 9, scope: !421)
!421 = distinct !DILexicalBlock(scope: !416, file: !1, line: 18, column: 5)
!422 = !DILocation(line: 20, column: 5, scope: !421)
!423 = !DILocation(line: 23, column: 9, scope: !424)
!424 = distinct !DILexicalBlock(scope: !416, file: !1, line: 22, column: 5)
!425 = !DILocation(line: 25, column: 5, scope: !366)
