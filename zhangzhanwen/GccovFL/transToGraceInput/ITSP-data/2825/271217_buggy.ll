; ModuleID = 'gcov/../WA_c/271217_buggy.c'
source_filename = "gcov/../WA_c/271217_buggy.c"
...
@.str.1 = private unnamed_addr constant [27 x i8] c"Point is inside the Circle\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"Point is on the Circle\00", align 1
@.str.3 = private unnamed_addr constant [28 x i8] c"Point is outside the Circle\00", align 1
...
define i32 @main() #0 !dbg !366 {
  ...
  call void @llvm.dbg.declare(metadata float* %2, metadata !369, metadata !DIExpression()), !dbg !370
  call void @llvm.dbg.declare(metadata float* %3, metadata !371, metadata !DIExpression()), !dbg !372
  call void @llvm.dbg.declare(metadata float* %4, metadata !373, metadata !DIExpression()), !dbg !374
  call void @llvm.dbg.declare(metadata float* %5, metadata !375, metadata !DIExpression()), !dbg !376
  call void @llvm.dbg.declare(metadata float* %6, metadata !377, metadata !DIExpression()), !dbg !378
  call void @llvm.dbg.declare(metadata float* %7, metadata !379, metadata !DIExpression()), !dbg !380
  call void @llvm.dbg.declare(metadata float* %8, metadata !381, metadata !DIExpression()), !dbg !382
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), float* %2, float* %3, float* %4, float* %5, float* %6), !dbg !383
  %10 = load float, float* %2, align 4, !dbg !384
  %11 = load float, float* %5, align 4, !dbg !385
  %12 = fsub float %10, %11, !dbg !386
  %13 = load float, float* %2, align 4, !dbg !387
  %14 = load float, float* %5, align 4, !dbg !388
  %15 = fsub float %13, %14, !dbg !389
  %16 = fmul float %12, %15, !dbg !390
  %17 = load float, float* %3, align 4, !dbg !391
  %18 = load float, float* %6, align 4, !dbg !392
  %19 = fsub float %17, %18, !dbg !393
  %20 = load float, float* %3, align 4, !dbg !394
  %21 = load float, float* %6, align 4, !dbg !395
  %22 = fsub float %20, %21, !dbg !396
  %23 = fmul float %19, %22, !dbg !397
  %24 = fadd float %16, %23, !dbg !398
  store float %24, float* %7, align 4, !dbg !399
  %25 = load float, float* %7, align 4, !dbg !400
  %26 = call float @_ZSt4sqrtf(float %25), !dbg !401
  store float %26, float* %8, align 4, !dbg !402
  %27 = load float, float* %8, align 4, !dbg !403
  %28 = load float, float* %4, align 4, !dbg !405
  %29 = fcmp olt float %27, %28, !dbg !406
  br i1 %29, label %30, label %32, !dbg !407

; <label>:30:                                     ; preds = %0
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.1, i32 0, i32 0)), !dbg !408
  br label %46, !dbg !410

; <label>:32:                                     ; preds = %0
  %33 = load float, float* %8, align 4, !dbg !411
  %34 = load float, float* %4, align 4, !dbg !413
  %35 = fcmp oeq float %33, %34, !dbg !414
  br i1 %35, label %36, label %38, !dbg !415

; <label>:36:                                     ; preds = %32
  %37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0)), !dbg !416
  br label %45, !dbg !418

; <label>:38:                                     ; preds = %32
  %39 = load float, float* %8, align 4, !dbg !419
  %40 = load float, float* %4, align 4, !dbg !421
  %41 = fcmp ogt float %39, %40, !dbg !422
  br i1 %41, label %42, label %44, !dbg !423

; <label>:42:                                     ; preds = %38
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3, i32 0, i32 0)), !dbg !424
  br label %44, !dbg !426
...
define linkonce_odr float @_ZSt4sqrtf(float) #3 comdat !dbg !428 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  call void @llvm.dbg.declare(metadata float* %2, metadata !429, metadata !DIExpression()), !dbg !430
  %3 = load float, float* %2, align 4, !dbg !431
  %4 = call float @sqrtf(float %3) #5, !dbg !432
  ret float %4, !dbg !433
}
...
!1 = !DIFile(filename: "gcov/../WA_c/271217_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!7 = !DIFile(filename: "/usr/include/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !10}
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/bits/std_abs.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
...
!368 = !{!10}
!369 = !DILocalVariable(name: "x", scope: !366, file: !1, line: 6, type: !76)
!370 = !DILocation(line: 6, column: 11, scope: !366)
!371 = !DILocalVariable(name: "y", scope: !366, file: !1, line: 6, type: !76)
!372 = !DILocation(line: 6, column: 13, scope: !366)
!373 = !DILocalVariable(name: "r", scope: !366, file: !1, line: 6, type: !76)
!374 = !DILocation(line: 6, column: 15, scope: !366)
!375 = !DILocalVariable(name: "x1", scope: !366, file: !1, line: 6, type: !76)
!376 = !DILocation(line: 6, column: 17, scope: !366)
!377 = !DILocalVariable(name: "y1", scope: !366, file: !1, line: 6, type: !76)
!378 = !DILocation(line: 6, column: 20, scope: !366)
!379 = !DILocalVariable(name: "d", scope: !366, file: !1, line: 6, type: !76)
!380 = !DILocation(line: 6, column: 23, scope: !366)
!381 = !DILocalVariable(name: "e", scope: !366, file: !1, line: 6, type: !76)
!382 = !DILocation(line: 6, column: 25, scope: !366)
!383 = !DILocation(line: 7, column: 5, scope: !366)
!384 = !DILocation(line: 8, column: 10, scope: !366)
!385 = !DILocation(line: 8, column: 12, scope: !366)
!386 = !DILocation(line: 8, column: 11, scope: !366)
!387 = !DILocation(line: 8, column: 17, scope: !366)
!388 = !DILocation(line: 8, column: 19, scope: !366)
!389 = !DILocation(line: 8, column: 18, scope: !366)
!390 = !DILocation(line: 8, column: 15, scope: !366)
!391 = !DILocation(line: 8, column: 24, scope: !366)
!392 = !DILocation(line: 8, column: 26, scope: !366)
!393 = !DILocation(line: 8, column: 25, scope: !366)
!394 = !DILocation(line: 8, column: 31, scope: !366)
!395 = !DILocation(line: 8, column: 33, scope: !366)
!396 = !DILocation(line: 8, column: 32, scope: !366)
!397 = !DILocation(line: 8, column: 29, scope: !366)
!398 = !DILocation(line: 8, column: 22, scope: !366)
!399 = !DILocation(line: 8, column: 7, scope: !366)
!400 = !DILocation(line: 9, column: 14, scope: !366)
!401 = !DILocation(line: 9, column: 9, scope: !366)
!402 = !DILocation(line: 9, column: 7, scope: !366)
!403 = !DILocation(line: 11, column: 6, scope: !404)
!404 = distinct !DILexicalBlock(scope: !366, file: !1, line: 11, column: 6)
!405 = !DILocation(line: 11, column: 8, scope: !404)
!406 = !DILocation(line: 11, column: 7, scope: !404)
!407 = !DILocation(line: 11, column: 6, scope: !366)
!408 = !DILocation(line: 13, column: 9, scope: !409)
!409 = distinct !DILexicalBlock(scope: !404, file: !1, line: 12, column: 5)
!410 = !DILocation(line: 14, column: 5, scope: !409)
!411 = !DILocation(line: 16, column: 6, scope: !412)
!412 = distinct !DILexicalBlock(scope: !404, file: !1, line: 16, column: 6)
!413 = !DILocation(line: 16, column: 9, scope: !412)
!414 = !DILocation(line: 16, column: 7, scope: !412)
!415 = !DILocation(line: 16, column: 6, scope: !404)
!416 = !DILocation(line: 18, column: 9, scope: !417)
!417 = distinct !DILexicalBlock(scope: !412, file: !1, line: 17, column: 5)
!418 = !DILocation(line: 19, column: 5, scope: !417)
!419 = !DILocation(line: 21, column: 6, scope: !420)
!420 = distinct !DILexicalBlock(scope: !412, file: !1, line: 21, column: 6)
!421 = !DILocation(line: 21, column: 8, scope: !420)
!422 = !DILocation(line: 21, column: 7, scope: !420)
!423 = !DILocation(line: 21, column: 6, scope: !412)
!424 = !DILocation(line: 23, column: 9, scope: !425)
!425 = distinct !DILexicalBlock(scope: !420, file: !1, line: 22, column: 5)
!426 = !DILocation(line: 24, column: 5, scope: !425)
!427 = !DILocation(line: 25, column: 5, scope: !366)
!428 = distinct !DISubprogram(name: "sqrt", linkageName: "_ZSt4sqrtf", scope: !5, file: !18, line: 463, type: !81, isLocal: false, isDefinition: true, scopeLine: 464, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!429 = !DILocalVariable(name: "__x", arg: 1, scope: !428, file: !18, line: 463, type: !76)
!430 = !DILocation(line: 463, column: 14, scope: !428)
!431 = !DILocation(line: 464, column: 28, scope: !428)
!432 = !DILocation(line: 464, column: 12, scope: !428)
!433 = !DILocation(line: 464, column: 5, scope: !428)
