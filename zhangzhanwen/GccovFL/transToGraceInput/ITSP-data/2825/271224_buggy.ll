; ModuleID = 'gcov/../WA_c/271224_buggy.c'
source_filename = "gcov/../WA_c/271224_buggy.c"
...
@.str.1 = private unnamed_addr constant [9 x i8] c"%f demo\0A\00", align 1
...
@.str.4 = private unnamed_addr constant [29 x i8] c"Point is outside the Circle.\00", align 1
...
define i32 @main() #0 !dbg !366 {
  ...
  %10 = load float, float* %5, align 4, !dbg !384
  %11 = load float, float* %2, align 4, !dbg !385
  %12 = fsub float %10, %11, !dbg !386
  %13 = load float, float* %5, align 4, !dbg !387
  %14 = load float, float* %2, align 4, !dbg !388
  %15 = fsub float %13, %14, !dbg !389
  %16 = fmul float %12, %15, !dbg !390
  %17 = load float, float* %6, align 4, !dbg !391
  %18 = load float, float* %3, align 4, !dbg !392
  %19 = fsub float %17, %18, !dbg !393
  %20 = load float, float* %6, align 4, !dbg !394
  %21 = load float, float* %3, align 4, !dbg !395
  ...
  %28 = fpext float %27 to double, !dbg !403
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0), double %28), !dbg !404
  %30 = load float, float* %8, align 4, !dbg !405
  %31 = load float, float* %4, align 4, !dbg !407
  %32 = fcmp olt float %30, %31, !dbg !408
  br i1 %32, label %33, label %35, !dbg !409

; <label>:33:                                     ; preds = %0
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0)), !dbg !410
  br label %44, !dbg !412

; <label>:35:                                     ; preds = %0
  %36 = load float, float* %8, align 4, !dbg !413
  %37 = load float, float* %4, align 4, !dbg !415
  %38 = fcmp oeq float %36, %37, !dbg !416
  br i1 %38, label %39, label %41, !dbg !417

; <label>:39:                                     ; preds = %35
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0)), !dbg !418
  br label %43, !dbg !420

; <label>:41:                                     ; preds = %35
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i32 0, i32 0)), !dbg !421
  br label %43
...
define linkonce_odr float @_ZSt4sqrtf(float) #3 comdat !dbg !424 {
  %2 = alloca float, align 4
  store float %0, float* %2, align 4
  call void @llvm.dbg.declare(metadata float* %2, metadata !425, metadata !DIExpression()), !dbg !426
  %3 = load float, float* %2, align 4, !dbg !427
  %4 = call float @sqrtf(float %3) #5, !dbg !428
  ret float %4, !dbg !429
}
...
!1 = !DIFile(filename: "gcov/../WA_c/271224_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2825")
!2 = !{}
...
!373 = !DILocalVariable(name: "r", scope: !366, file: !1, line: 5, type: !76)
!374 = !DILocation(line: 5, column: 15, scope: !366)
!375 = !DILocalVariable(name: "x1", scope: !366, file: !1, line: 6, type: !76)
!376 = !DILocation(line: 6, column: 11, scope: !366)
!377 = !DILocalVariable(name: "y1", scope: !366, file: !1, line: 7, type: !76)
!378 = !DILocation(line: 7, column: 11, scope: !366)
!379 = !DILocalVariable(name: "h", scope: !366, file: !1, line: 8, type: !76)
!380 = !DILocation(line: 8, column: 11, scope: !366)
!381 = !DILocalVariable(name: "g", scope: !366, file: !1, line: 9, type: !76)
!382 = !DILocation(line: 9, column: 11, scope: !366)
!383 = !DILocation(line: 10, column: 5, scope: !366)
!384 = !DILocation(line: 11, column: 8, scope: !366)
!385 = !DILocation(line: 11, column: 11, scope: !366)
!386 = !DILocation(line: 11, column: 10, scope: !366)
!387 = !DILocation(line: 11, column: 15, scope: !366)
!388 = !DILocation(line: 11, column: 18, scope: !366)
!389 = !DILocation(line: 11, column: 17, scope: !366)
!390 = !DILocation(line: 11, column: 13, scope: !366)
!391 = !DILocation(line: 11, column: 22, scope: !366)
!392 = !DILocation(line: 11, column: 25, scope: !366)
!393 = !DILocation(line: 11, column: 24, scope: !366)
!394 = !DILocation(line: 11, column: 29, scope: !366)
!395 = !DILocation(line: 11, column: 32, scope: !366)
!396 = !DILocation(line: 11, column: 31, scope: !366)
!397 = !DILocation(line: 11, column: 27, scope: !366)
!398 = !DILocation(line: 11, column: 20, scope: !366)
!399 = !DILocation(line: 11, column: 6, scope: !366)
!400 = !DILocation(line: 12, column: 12, scope: !366)
!401 = !DILocation(line: 12, column: 7, scope: !366)
!402 = !DILocation(line: 12, column: 6, scope: !366)
!403 = !DILocation(line: 13, column: 24, scope: !366)
!404 = !DILocation(line: 13, column: 5, scope: !366)
!405 = !DILocation(line: 14, column: 8, scope: !406)
!406 = distinct !DILexicalBlock(scope: !366, file: !1, line: 14, column: 8)
!407 = !DILocation(line: 14, column: 10, scope: !406)
!408 = !DILocation(line: 14, column: 9, scope: !406)
!409 = !DILocation(line: 14, column: 8, scope: !366)
!410 = !DILocation(line: 16, column: 9, scope: !411)
!411 = distinct !DILexicalBlock(scope: !406, file: !1, line: 15, column: 5)
!412 = !DILocation(line: 17, column: 5, scope: !411)
!413 = !DILocation(line: 18, column: 13, scope: !414)
!414 = distinct !DILexicalBlock(scope: !406, file: !1, line: 18, column: 13)
!415 = !DILocation(line: 18, column: 16, scope: !414)
!416 = !DILocation(line: 18, column: 14, scope: !414)
!417 = !DILocation(line: 18, column: 13, scope: !406)
!418 = !DILocation(line: 20, column: 9, scope: !419)
!419 = distinct !DILexicalBlock(scope: !414, file: !1, line: 19, column: 5)
!420 = !DILocation(line: 21, column: 5, scope: !419)
!421 = !DILocation(line: 24, column: 9, scope: !422)
!422 = distinct !DILexicalBlock(scope: !414, file: !1, line: 23, column: 5)
!423 = !DILocation(line: 26, column: 5, scope: !366)
!424 = distinct !DISubprogram(name: "sqrt", linkageName: "_ZSt4sqrtf", scope: !5, file: !18, line: 463, type: !81, isLocal: false, isDefinition: true, scopeLine: 464, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!425 = !DILocalVariable(name: "__x", arg: 1, scope: !424, file: !18, line: 463, type: !76)
!426 = !DILocation(line: 463, column: 14, scope: !424)
!427 = !DILocation(line: 464, column: 28, scope: !424)
!428 = !DILocation(line: 464, column: 12, scope: !424)
!429 = !DILocation(line: 464, column: 5, scope: !424)
