; ModuleID = 'gcov/../WA_c/466340_buggy.c'
source_filename = "gcov/../WA_c/466340_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  %10 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %5), !dbg !377
  br label %11, !dbg !378

; <label>:11:                                     ; preds = %36, %0
  %12 = load i32, i32* %5, align 4, !dbg !379
  %13 = icmp ne i32 %12, 0, !dbg !380
  br i1 %13, label %14, label %49, !dbg !378

; <label>:14:                                     ; preds = %11
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i32* %2, i32* %4), !dbg !381
  call void @llvm.dbg.declare(metadata i32* %6, metadata !383, metadata !DIExpression()), !dbg !384
  %16 = load i32, i32* %2, align 4, !dbg !385
  store i32 %16, i32* %6, align 4, !dbg !384
  call void @llvm.dbg.declare(metadata i32* %7, metadata !386, metadata !DIExpression()), !dbg !387
  %17 = load i32, i32* %4, align 4, !dbg !388
  store i32 %17, i32* %7, align 4, !dbg !387
  %18 = load i32, i32* %2, align 4, !dbg !389
  %19 = load i32, i32* %4, align 4, !dbg !391
  %20 = icmp slt i32 %18, %19, !dbg !392
  br i1 %20, label %21, label %25, !dbg !393

; <label>:21:                                     ; preds = %14
  %22 = load i32, i32* %2, align 4, !dbg !394
  store i32 %22, i32* %3, align 4, !dbg !396
  %23 = load i32, i32* %4, align 4, !dbg !397
  store i32 %23, i32* %2, align 4, !dbg !398
  %24 = load i32, i32* %3, align 4, !dbg !399
  store i32 %24, i32* %4, align 4, !dbg !400
  br label %26, !dbg !401
...
; <label>:27:                                     ; preds = %30, %26
  %28 = load i32, i32* %8, align 4, !dbg !405
  %29 = icmp ne i32 %28, 0, !dbg !406
  br i1 %29, label %30, label %36, !dbg !404

; <label>:30:                                     ; preds = %27
  %31 = load i32, i32* %2, align 4, !dbg !407
  %32 = load i32, i32* %4, align 4, !dbg !409
  %33 = srem i32 %31, %32, !dbg !410
  store i32 %33, i32* %8, align 4, !dbg !411
  %34 = load i32, i32* %4, align 4, !dbg !412
  store i32 %34, i32* %2, align 4, !dbg !413
  %35 = load i32, i32* %8, align 4, !dbg !414
  store i32 %35, i32* %4, align 4, !dbg !415
  br label %27, !dbg !404, !llvm.loop !416

; <label>:36:                                     ; preds = %27
  call void @llvm.dbg.declare(metadata i32* %9, metadata !418, metadata !DIExpression()), !dbg !419
  %37 = load i32, i32* %6, align 4, !dbg !420
  %38 = load i32, i32* %2, align 4, !dbg !421
  %39 = sdiv i32 %37, %38, !dbg !422
  %40 = load i32, i32* %7, align 4, !dbg !423
  %41 = load i32, i32* %2, align 4, !dbg !424
  %42 = sdiv i32 %40, %41, !dbg !425
  %43 = add nsw i32 %39, %42, !dbg !426
  %44 = add nsw i32 %43, 1, !dbg !427
  store i32 %44, i32* %9, align 4, !dbg !419
  %45 = load i32, i32* %9, align 4, !dbg !428
  %46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %45), !dbg !429
  %47 = load i32, i32* %5, align 4, !dbg !430
  %48 = add nsw i32 %47, -1, !dbg !430
  store i32 %48, i32* %5, align 4, !dbg !430
  br label %11, !dbg !378, !llvm.loop !431

; <label>:49:                                     ; preds = %11
  %50 = load i32, i32* %1, align 4, !dbg !433
  ret i32 %50, !dbg !433
}
...
!1 = !DIFile(filename: "gcov/../WA_c/466340_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
!2 = !{}
...
!371 = !DILocalVariable(name: "t", scope: !366, file: !1, line: 5, type: !10)
!372 = !DILocation(line: 5, column: 12, scope: !366)
!373 = !DILocalVariable(name: "n", scope: !366, file: !1, line: 5, type: !10)
!374 = !DILocation(line: 5, column: 15, scope: !366)
!375 = !DILocalVariable(name: "k", scope: !366, file: !1, line: 5, type: !10)
!376 = !DILocation(line: 5, column: 18, scope: !366)
!377 = !DILocation(line: 6, column: 5, scope: !366)
!378 = !DILocation(line: 7, column: 5, scope: !366)
!379 = !DILocation(line: 7, column: 11, scope: !366)
!380 = !DILocation(line: 7, column: 13, scope: !366)
!381 = !DILocation(line: 9, column: 9, scope: !382)
!382 = distinct !DILexicalBlock(scope: !366, file: !1, line: 8, column: 5)
!383 = !DILocalVariable(name: "b", scope: !382, file: !1, line: 10, type: !10)
!384 = !DILocation(line: 10, column: 13, scope: !382)
!385 = !DILocation(line: 10, column: 17, scope: !382)
!386 = !DILocalVariable(name: "c", scope: !382, file: !1, line: 11, type: !10)
!387 = !DILocation(line: 11, column: 13, scope: !382)
!388 = !DILocation(line: 11, column: 17, scope: !382)
!389 = !DILocation(line: 12, column: 12, scope: !390)
!390 = distinct !DILexicalBlock(scope: !382, file: !1, line: 12, column: 12)
!391 = !DILocation(line: 12, column: 16, scope: !390)
!392 = !DILocation(line: 12, column: 14, scope: !390)
!393 = !DILocation(line: 12, column: 12, scope: !382)
!394 = !DILocation(line: 14, column: 17, scope: !395)
!395 = distinct !DILexicalBlock(scope: !390, file: !1, line: 13, column: 9)
!396 = !DILocation(line: 14, column: 15, scope: !395)
!397 = !DILocation(line: 15, column: 17, scope: !395)
!398 = !DILocation(line: 15, column: 15, scope: !395)
!399 = !DILocation(line: 16, column: 17, scope: !395)
!400 = !DILocation(line: 16, column: 15, scope: !395)
!401 = !DILocation(line: 17, column: 9, scope: !395)
!402 = !DILocalVariable(name: "a", scope: !382, file: !1, line: 20, type: !10)
!403 = !DILocation(line: 20, column: 13, scope: !382)
!404 = !DILocation(line: 21, column: 9, scope: !382)
!405 = !DILocation(line: 21, column: 15, scope: !382)
!406 = !DILocation(line: 21, column: 17, scope: !382)
!407 = !DILocation(line: 23, column: 17, scope: !408)
!408 = distinct !DILexicalBlock(scope: !382, file: !1, line: 22, column: 9)
!409 = !DILocation(line: 23, column: 21, scope: !408)
!410 = !DILocation(line: 23, column: 19, scope: !408)
!411 = !DILocation(line: 23, column: 15, scope: !408)
!412 = !DILocation(line: 24, column: 17, scope: !408)
!413 = !DILocation(line: 24, column: 15, scope: !408)
!414 = !DILocation(line: 25, column: 17, scope: !408)
!415 = !DILocation(line: 25, column: 15, scope: !408)
!416 = distinct !{!416, !404, !417}
!417 = !DILocation(line: 26, column: 9, scope: !382)
!418 = !DILocalVariable(name: "sum", scope: !382, file: !1, line: 27, type: !10)
!419 = !DILocation(line: 27, column: 13, scope: !382)
!420 = !DILocation(line: 27, column: 19, scope: !382)
!421 = !DILocation(line: 27, column: 23, scope: !382)
!422 = !DILocation(line: 27, column: 21, scope: !382)
!423 = !DILocation(line: 27, column: 27, scope: !382)
!424 = !DILocation(line: 27, column: 31, scope: !382)
!425 = !DILocation(line: 27, column: 29, scope: !382)
!426 = !DILocation(line: 27, column: 25, scope: !382)
!427 = !DILocation(line: 27, column: 33, scope: !382)
!428 = !DILocation(line: 28, column: 24, scope: !382)
!429 = !DILocation(line: 28, column: 9, scope: !382)
!430 = !DILocation(line: 29, column: 10, scope: !382)
!431 = distinct !{!431, !378, !432}
!432 = !DILocation(line: 30, column: 5, scope: !366)
!433 = !DILocation(line: 31, column: 1, scope: !366)
