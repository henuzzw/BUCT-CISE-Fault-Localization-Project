; ModuleID = 'gcov/../WA_c/466073_buggy.c'
source_filename = "gcov/../WA_c/466073_buggy.c"
...
define i32 @main() #0 !dbg !366 {
  ...
  store i32 1, i32* %6, align 4, !dbg !378
  call void @llvm.dbg.declare(metadata i32* %7, metadata !379, metadata !DIExpression()), !dbg !380
  call void @llvm.dbg.declare(metadata i32* %8, metadata !381, metadata !DIExpression()), !dbg !382
  %9 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %2), !dbg !383
  store i32 0, i32* %7, align 4, !dbg !384
  br label %10, !dbg !386

; <label>:10:                                     ; preds = %55, %0
  %11 = load i32, i32* %7, align 4, !dbg !387
  %12 = load i32, i32* %2, align 4, !dbg !389
  %13 = icmp slt i32 %11, %12, !dbg !390
  br i1 %13, label %14, label %58, !dbg !391

; <label>:14:                                     ; preds = %10
  store i32 1, i32* %6, align 4, !dbg !392
  %15 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i32* %4, i32* %3), !dbg !394
  %16 = load i32, i32* %4, align 4, !dbg !395
  %17 = load i32, i32* %3, align 4, !dbg !396
  %18 = add nsw i32 %16, %17, !dbg !397
  %19 = add nsw i32 %18, 1, !dbg !398
  store i32 %19, i32* %8, align 4, !dbg !399
  %20 = load i32, i32* %4, align 4, !dbg !400
  %21 = load i32, i32* %3, align 4, !dbg !402
  %22 = icmp eq i32 %20, %21, !dbg !403
  br i1 %22, label %23, label %25, !dbg !404

; <label>:23:                                     ; preds = %14
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0)), !dbg !405
  br label %25, !dbg !405

; <label>:25:                                     ; preds = %23, %14
  %26 = load i32, i32* %3, align 4, !dbg !406
  %27 = load i32, i32* %4, align 4, !dbg !408
  %28 = icmp sgt i32 %26, %27, !dbg !409
  br i1 %28, label %29, label %33, !dbg !410

; <label>:29:                                     ; preds = %25
  %30 = load i32, i32* %3, align 4, !dbg !411
  store i32 %30, i32* %5, align 4, !dbg !413
  %31 = load i32, i32* %4, align 4, !dbg !414
  store i32 %31, i32* %3, align 4, !dbg !415
  %32 = load i32, i32* %5, align 4, !dbg !416
  store i32 %32, i32* %4, align 4, !dbg !417
  br label %33, !dbg !418
...
; <label>:34:                                     ; preds = %49, %33
  %35 = load i32, i32* %6, align 4, !dbg !420
  %36 = icmp ne i32 %35, 0, !dbg !420
  br i1 %36, label %37, label %50, !dbg !419

; <label>:37:                                     ; preds = %34
  %38 = load i32, i32* %4, align 4, !dbg !421
  %39 = load i32, i32* %3, align 4, !dbg !423
  %40 = sub nsw i32 %38, %39, !dbg !424
  store i32 %40, i32* %6, align 4, !dbg !425
  %41 = load i32, i32* %6, align 4, !dbg !426
  %42 = load i32, i32* %3, align 4, !dbg !428
  %43 = icmp sgt i32 %41, %42, !dbg !429
  br i1 %43, label %44, label %46, !dbg !430

; <label>:44:                                     ; preds = %37
  %45 = load i32, i32* %6, align 4, !dbg !431
  store i32 %45, i32* %4, align 4, !dbg !432
  br label %49, !dbg !433

; <label>:46:                                     ; preds = %37
  %47 = load i32, i32* %3, align 4, !dbg !434
  store i32 %47, i32* %4, align 4, !dbg !436
  %48 = load i32, i32* %6, align 4, !dbg !437
  store i32 %48, i32* %3, align 4, !dbg !438
  br label %49

; <label>:49:                                     ; preds = %46, %44
  br label %34, !dbg !419, !llvm.loop !439

; <label>:50:                                     ; preds = %34
  %51 = load i32, i32* %8, align 4, !dbg !441
  %52 = load i32, i32* %4, align 4, !dbg !442
  %53 = sdiv i32 %51, %52, !dbg !443
  %54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i32 %53), !dbg !444
  br label %55, !dbg !445

; <label>:55:                                     ; preds = %50
  %56 = load i32, i32* %7, align 4, !dbg !446
  %57 = add nsw i32 %56, 1, !dbg !446
  store i32 %57, i32* %7, align 4, !dbg !446
  br label %10, !dbg !447, !llvm.loop !448

; <label>:58:                                     ; preds = %10
  %59 = load i32, i32* %1, align 4, !dbg !450
  ret i32 %59, !dbg !450
}
...
!1 = !DIFile(filename: "gcov/../WA_c/466073_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
!2 = !{}
...
!7 = !DIFile(filename: "/usr/include/stdlib.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !10}
!10 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!11 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/bits/std_abs.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
...
!14 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/mathcalls.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
!15 = !DISubroutineType(types: !16)
!16 = !{!17, !17}
!17 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!18 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/cmath", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
...
!73 = !DIFile(filename: "/usr/include/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
...
!356 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.5.0/../../../../include/c++/7.5.0/math.h", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/1687")
...
!366 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 4, type: !367, isLocal: false, isDefinition: true, scopeLine: 5, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!367 = !DISubroutineType(types: !368)
!368 = !{!10}
!369 = !DILocalVariable(name: "k", scope: !366, file: !1, line: 6, type: !10)
!370 = !DILocation(line: 6, column: 9, scope: !366)
!371 = !DILocalVariable(name: "n", scope: !366, file: !1, line: 6, type: !10)
!372 = !DILocation(line: 6, column: 12, scope: !366)
!373 = !DILocalVariable(name: "m", scope: !366, file: !1, line: 6, type: !10)
!374 = !DILocation(line: 6, column: 15, scope: !366)
!375 = !DILocalVariable(name: "l", scope: !366, file: !1, line: 6, type: !10)
!376 = !DILocation(line: 6, column: 18, scope: !366)
!377 = !DILocalVariable(name: "p", scope: !366, file: !1, line: 6, type: !10)
!378 = !DILocation(line: 6, column: 21, scope: !366)
!379 = !DILocalVariable(name: "i", scope: !366, file: !1, line: 6, type: !10)
!380 = !DILocation(line: 6, column: 28, scope: !366)
!381 = !DILocalVariable(name: "o", scope: !366, file: !1, line: 6, type: !10)
!382 = !DILocation(line: 6, column: 31, scope: !366)
!383 = !DILocation(line: 7, column: 5, scope: !366)
!384 = !DILocation(line: 8, column: 11, scope: !385)
!385 = distinct !DILexicalBlock(scope: !366, file: !1, line: 8, column: 5)
!386 = !DILocation(line: 8, column: 9, scope: !385)
!387 = !DILocation(line: 8, column: 16, scope: !388)
!388 = distinct !DILexicalBlock(scope: !385, file: !1, line: 8, column: 5)
!389 = !DILocation(line: 8, column: 20, scope: !388)
!390 = !DILocation(line: 8, column: 18, scope: !388)
!391 = !DILocation(line: 8, column: 5, scope: !385)
!392 = !DILocation(line: 10, column: 11, scope: !393)
!393 = distinct !DILexicalBlock(scope: !388, file: !1, line: 9, column: 5)
!394 = !DILocation(line: 11, column: 9, scope: !393)
!395 = !DILocation(line: 12, column: 13, scope: !393)
!396 = !DILocation(line: 12, column: 17, scope: !393)
!397 = !DILocation(line: 12, column: 15, scope: !393)
!398 = !DILocation(line: 12, column: 19, scope: !393)
!399 = !DILocation(line: 12, column: 11, scope: !393)
!400 = !DILocation(line: 13, column: 12, scope: !401)
!401 = distinct !DILexicalBlock(scope: !393, file: !1, line: 13, column: 12)
!402 = !DILocation(line: 13, column: 17, scope: !401)
!403 = !DILocation(line: 13, column: 14, scope: !401)
!404 = !DILocation(line: 13, column: 12, scope: !393)
!405 = !DILocation(line: 14, column: 13, scope: !401)
!406 = !DILocation(line: 15, column: 12, scope: !407)
!407 = distinct !DILexicalBlock(scope: !393, file: !1, line: 15, column: 12)
!408 = !DILocation(line: 15, column: 16, scope: !407)
!409 = !DILocation(line: 15, column: 14, scope: !407)
!410 = !DILocation(line: 15, column: 12, scope: !393)
!411 = !DILocation(line: 17, column: 17, scope: !412)
!412 = distinct !DILexicalBlock(scope: !407, file: !1, line: 16, column: 9)
!413 = !DILocation(line: 17, column: 15, scope: !412)
!414 = !DILocation(line: 18, column: 17, scope: !412)
!415 = !DILocation(line: 18, column: 15, scope: !412)
!416 = !DILocation(line: 19, column: 17, scope: !412)
!417 = !DILocation(line: 19, column: 15, scope: !412)
!418 = !DILocation(line: 20, column: 9, scope: !412)
!419 = !DILocation(line: 21, column: 9, scope: !393)
!420 = !DILocation(line: 21, column: 15, scope: !393)
!421 = !DILocation(line: 23, column: 17, scope: !422)
!422 = distinct !DILexicalBlock(scope: !393, file: !1, line: 22, column: 9)
!423 = !DILocation(line: 23, column: 21, scope: !422)
!424 = !DILocation(line: 23, column: 19, scope: !422)
!425 = !DILocation(line: 23, column: 15, scope: !422)
!426 = !DILocation(line: 24, column: 16, scope: !427)
!427 = distinct !DILexicalBlock(scope: !422, file: !1, line: 24, column: 16)
!428 = !DILocation(line: 24, column: 20, scope: !427)
!429 = !DILocation(line: 24, column: 18, scope: !427)
!430 = !DILocation(line: 24, column: 16, scope: !422)
!431 = !DILocation(line: 25, column: 21, scope: !427)
!432 = !DILocation(line: 25, column: 19, scope: !427)
!433 = !DILocation(line: 25, column: 17, scope: !427)
!434 = !DILocation(line: 28, column: 21, scope: !435)
!435 = distinct !DILexicalBlock(scope: !427, file: !1, line: 27, column: 13)
!436 = !DILocation(line: 28, column: 19, scope: !435)
!437 = !DILocation(line: 29, column: 21, scope: !435)
!438 = !DILocation(line: 29, column: 19, scope: !435)
!439 = distinct !{!439, !419, !440}
!440 = !DILocation(line: 31, column: 9, scope: !393)
!441 = !DILocation(line: 32, column: 24, scope: !393)
!442 = !DILocation(line: 32, column: 28, scope: !393)
!443 = !DILocation(line: 32, column: 26, scope: !393)
!444 = !DILocation(line: 32, column: 9, scope: !393)
!445 = !DILocation(line: 33, column: 5, scope: !393)
!446 = !DILocation(line: 8, column: 24, scope: !388)
!447 = !DILocation(line: 8, column: 5, scope: !388)
!448 = distinct !{!448, !391, !449}
!449 = !DILocation(line: 33, column: 5, scope: !385)
!450 = !DILocation(line: 34, column: 1, scope: !366)
