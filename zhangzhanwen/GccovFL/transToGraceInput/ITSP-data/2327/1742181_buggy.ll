; ModuleID = 'gcov/../WA_c/1742181_buggy.c'
source_filename = "gcov/../WA_c/1742181_buggy.c"
...
define i32 @main() #0 !dbg !381 {
  ...
  store i32 0, i32* %2, align 4, !dbg !385
...
; <label>:6:                                      ; preds = %35, %0
  %7 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %2), !dbg !393
  %8 = icmp ne i32 %7, -1, !dbg !394
  br i1 %8, label %9, label %36, !dbg !392

; <label>:9:                                      ; preds = %6
  %10 = load i32, i32* %2, align 4, !dbg !395
  store i32 %10, i32* %3, align 4, !dbg !397
  store i32 0, i32* %5, align 4, !dbg !398
  %11 = load i32, i32* %5, align 4, !dbg !399
  %12 = add nsw i32 %11, 1, !dbg !399
  store i32 %12, i32* %5, align 4, !dbg !399
  br label %13, !dbg !400

; <label>:13:                                     ; preds = %16, %9
  %14 = load i32, i32* %3, align 4, !dbg !401
  %15 = icmp sgt i32 %14, 0, !dbg !402
  br i1 %15, label %16, label %27, !dbg !400

; <label>:16:                                     ; preds = %13
  %17 = load i32, i32* %3, align 4, !dbg !403
  %18 = srem i32 %17, 10, !dbg !405
  store i32 %18, i32* %4, align 4, !dbg !406
  %19 = load i32, i32* %4, align 4, !dbg !407
  %20 = call double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32 %19, i32 7), !dbg !408
  %21 = load i32, i32* %5, align 4, !dbg !409
  %22 = sitofp i32 %21 to double, !dbg !409
  %23 = fadd double %22, %20, !dbg !409
  %24 = fptosi double %23 to i32, !dbg !409
  store i32 %24, i32* %5, align 4, !dbg !409
  %25 = load i32, i32* %3, align 4, !dbg !410
  %26 = sdiv i32 %25, 10, !dbg !411
  store i32 %26, i32* %3, align 4, !dbg !412
  br label %13, !dbg !400, !llvm.loop !413

; <label>:27:                                     ; preds = %13
  %28 = load i32, i32* %5, align 4, !dbg !415
  %29 = load i32, i32* %2, align 4, !dbg !417
  %30 = icmp eq i32 %28, %29, !dbg !418
  br i1 %30, label %31, label %33, !dbg !419

; <label>:31:                                     ; preds = %27
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0)), !dbg !420
  br label %35, !dbg !420

; <label>:33:                                     ; preds = %27
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0)), !dbg !421
  br label %35

; <label>:35:                                     ; preds = %33, %31
  br label %6, !dbg !392, !llvm.loop !422
...
define linkonce_odr double @_ZSt3powIiiEN9__gnu_cxx11__promote_2IT_T0_NS0_9__promoteIS2_Xsr3std12__is_integerIS2_EE7__valueEE6__typeENS4_IS3_Xsr3std12__is_integerIS3_EE7__valueEE6__typeEE6__typeES2_S3_(i32, i32) #3 comdat !dbg !6 {
  ...
  call void @llvm.dbg.declare(metadata i32* %3, metadata !425, metadata !DIExpression()), !dbg !426
  store i32 %1, i32* %4, align 4
  call void @llvm.dbg.declare(metadata i32* %4, metadata !427, metadata !DIExpression()), !dbg !428
  %5 = load i32, i32* %3, align 4, !dbg !429
  %6 = sitofp i32 %5 to double, !dbg !429
  %7 = load i32, i32* %4, align 4, !dbg !430
  %8 = sitofp i32 %7 to double, !dbg !430
  %9 = call double @pow(double %6, double %8) #5, !dbg !431
  ret double %9, !dbg !432
}
...
!1 = !DIFile(filename: "gcov/../WA_c/1742181_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2327")
!2 = !{}
!3 = !{!4}
...
!383 = !{!16}
!384 = !DILocalVariable(name: "num", scope: !381, file: !1, line: 5, type: !16)
!385 = !DILocation(line: 5, column: 9, scope: !381)
!386 = !DILocalVariable(name: "n", scope: !381, file: !1, line: 5, type: !16)
!387 = !DILocation(line: 5, column: 18, scope: !381)
!388 = !DILocalVariable(name: "a", scope: !381, file: !1, line: 5, type: !16)
!389 = !DILocation(line: 5, column: 21, scope: !381)
!390 = !DILocalVariable(name: "sum", scope: !381, file: !1, line: 5, type: !16)
!391 = !DILocation(line: 5, column: 24, scope: !381)
!392 = !DILocation(line: 7, column: 5, scope: !381)
!393 = !DILocation(line: 7, column: 11, scope: !381)
!394 = !DILocation(line: 7, column: 29, scope: !381)
!395 = !DILocation(line: 9, column: 13, scope: !396)
!396 = distinct !DILexicalBlock(scope: !381, file: !1, line: 8, column: 5)
!397 = !DILocation(line: 9, column: 11, scope: !396)
!398 = !DILocation(line: 10, column: 13, scope: !396)
!399 = !DILocation(line: 11, column: 12, scope: !396)
!400 = !DILocation(line: 12, column: 9, scope: !396)
!401 = !DILocation(line: 12, column: 15, scope: !396)
!402 = !DILocation(line: 12, column: 17, scope: !396)
!403 = !DILocation(line: 14, column: 17, scope: !404)
!404 = distinct !DILexicalBlock(scope: !396, file: !1, line: 13, column: 9)
!405 = !DILocation(line: 14, column: 19, scope: !404)
!406 = !DILocation(line: 14, column: 15, scope: !404)
!407 = !DILocation(line: 15, column: 24, scope: !404)
!408 = !DILocation(line: 15, column: 20, scope: !404)
!409 = !DILocation(line: 15, column: 17, scope: !404)
!410 = !DILocation(line: 16, column: 17, scope: !404)
!411 = !DILocation(line: 16, column: 19, scope: !404)
!412 = !DILocation(line: 16, column: 15, scope: !404)
!413 = distinct !{!413, !400, !414}
!414 = !DILocation(line: 17, column: 9, scope: !396)
!415 = !DILocation(line: 18, column: 12, scope: !416)
!416 = distinct !DILexicalBlock(scope: !396, file: !1, line: 18, column: 12)
!417 = !DILocation(line: 18, column: 19, scope: !416)
!418 = !DILocation(line: 18, column: 16, scope: !416)
!419 = !DILocation(line: 18, column: 12, scope: !396)
!420 = !DILocation(line: 19, column: 13, scope: !416)
!421 = !DILocation(line: 21, column: 13, scope: !416)
!422 = distinct !{!422, !392, !423}
!423 = !DILocation(line: 23, column: 5, scope: !381)
!424 = !DILocation(line: 24, column: 5, scope: !381)
!425 = !DILocalVariable(name: "__x", arg: 1, scope: !6, file: !5, line: 415, type: !16)
!426 = !DILocation(line: 415, column: 13, scope: !6)
!427 = !DILocalVariable(name: "__y", arg: 2, scope: !6, file: !5, line: 415, type: !16)
!428 = !DILocation(line: 415, column: 22, scope: !6)
!429 = !DILocation(line: 418, column: 25, scope: !6)
!430 = !DILocation(line: 418, column: 38, scope: !6)
!431 = !DILocation(line: 418, column: 14, scope: !6)
!432 = !DILocation(line: 418, column: 7, scope: !6)
