; ModuleID = 'gcov/../WA_c/270399_buggy.c'
source_filename = "gcov/../WA_c/270399_buggy.c"
...
; <label>:49:                                     ; preds = %0
  ...
  %54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0), double %51, double %53), !dbg !73
  br label %55
...
!1 = !DIFile(filename: "gcov/../WA_c/270399_buggy.c", directory: "/home/bhxz/ForGraduate/ForGccvFL2.0/transToGraceInput/ITSP-data/2813")
!2 = !{}
...
!72 = !DILocation(line: 20, column: 32, scope: !71)
